...
namespace SampleBrowser
{
    public partial class EmployeeReport : SampleView
    {
        ...
        void LoadAllowedTextsLabel()
        {
            ...
            label.Text = "This sample demonstrates how to create an employee report using Mail merge functionality of Essential DocIO.";
            label.Lines = 0;
        ...
        void OnButtonClicked(object sender, EventArgs e)
        {
            ...
            if (stream != null)
            {
                ...
                iOSSave.Save("EmployeeReport.docx", "application/msword", stream);
            }
        }
