...
namespace SampleBrowser
{
    public partial class NestedMailMerge : SampleView
    {
        ...
        void LoadAllowedTextsLabel()
        {
            ...
            label.Text = "This sample demonstrates how to perform Mail merge for nested groups in Word document using Essential DocIO.";
            label.Lines = 0;
        ...
        void OnButtonClicked(object sender, EventArgs e)
        {
            ...
            if (stream != null)
            {
                ...
                iOSSave.Save("NestedMailMerge.docx", "application/msword", stream);
            }
        }
