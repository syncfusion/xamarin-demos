...
namespace SampleBrowser
{
    public partial class TableofContents : SampleView
    {
        ...
        void LoadAllowedTextsLabel()
        {
            ...
            label.Text = "This sample demonstrates how to insert and update the Table of Contents (TOC) in a Word document using Essential DocIO.";
            ...
            {
                imageTypelabel.Frame = new CGRect(10, 70, frameRect.Location.X + frameRect.Size.Width - 20, 50);
            ...
            {
                radioGroup.Frame = new CGRect(110, 80, frameRect.Width - 90, 30);
            }
            ...
            {
                generateButton.Frame = new CGRect(0, (this.Frame.Size.Height / 3) - 25, frameRect.Location.X + frameRect.Size.Width, 10);
            }
