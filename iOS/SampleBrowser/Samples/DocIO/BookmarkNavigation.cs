...
namespace SampleBrowser
{
    public partial class BookmarkNavigation : SampleView
    {
        ...
        void LoadAllowedTextsLabel()
        {
            ...
            if (UIDevice.CurrentDevice.UserInterfaceIdiom == UIUserInterfaceIdiom.Pad)
            {
                button.Frame = new CGRect(0, 80, frameRect.Location.X + frameRect.Size.Width, 10);
            }
            else
            {
                button.Frame = new CGRect(frameRect.Location.X, 135, frameRect.Size.Width, 10);
            ...
            if (UIDevice.CurrentDevice.UserInterfaceIdiom == UIUserInterfaceIdiom.Pad)
            {
                viewButton.Frame = new CGRect(0, 70, frameRect.Location.X + frameRect.Size.Width, 10);
            }
            else
            {
                viewButton.Frame = new CGRect(frameRect.Location.X, 105, frameRect.Size.Width, 10);
        ...
        void OnButtonClicked(object sender, EventArgs e)
        {
            ...
            {
                SaveiOS iOSSave = new SaveiOS();
                iOSSave.Save("Bookmark Navigation.docx", "application/msword", stream);
            }
