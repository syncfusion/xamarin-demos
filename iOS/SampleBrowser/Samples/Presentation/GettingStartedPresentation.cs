...
namespace SampleBrowser
{
	public partial class GettingStartedPresentation : SampleView
	{
		...
		void LoadAllowedTextsLabel()
		{
			...
			label.Text = "This sample demonstrates how to create a PowerPoint presentation by adding text with simple text formatting.";
			...
			if (UIDevice.CurrentDevice.UserInterfaceIdiom == UIUserInterfaceIdiom.Pad) {
				...
				label.Frame = new CGRect (frameRect.Location.X, 5, frameRect.Size.Width , 85);
			...
			if (UIDevice.CurrentDevice.UserInterfaceIdiom == UIUserInterfaceIdiom.Pad) {
				...
				button.Frame = new CGRect (frameRect.Location.X, 85, frameRect.Size.Width , 10);
