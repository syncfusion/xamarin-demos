...
{
	public partial class HeaderAndFooterPresentation : SampleView
	{
		...
		UILabel label1;
		UIButton button;
		public HeaderAndFooterPresentation()
		{
		...
		void LoadAllowedTextsLabel()
		{
			...
			label.Text = "This sample demonstrates how to insert a header and footer in a PowerPoint Presentation.";
