...
namespace SampleBrowser
{
	public class AppointmentEditor : SampleView
	{
		...
		private static UIButton button_cancel;
		private static UIButton button_save;
		private static UITextView label_subject;
		private static UITextView label_location;
		private static UILabel label_starts;
		private static UILabel label_ends;
		private static UIButton button_startDate;
		private static UIButton button_endDate;
		private static UIDatePicker picker_startDate;
		private static UIDatePicker picker_endDate;
		private static UIButton done_button;
