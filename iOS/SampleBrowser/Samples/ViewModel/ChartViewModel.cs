...
namespace SampleBrowser
{
	public class ChartViewModel
	{
		...
		public ObservableCollection<ChartDataModel> verticalChart 
		{
			get
			{
				var items = new ObservableCollection<ChartDataModel>();
				...
				for (int i = 0; i < 30; i++)
				{
					items.Add(dataPointWithTimeInterval(0.15));
				}
		...
		{
			int count = (int)verticalChart.Count;
			NSNumber value;
			...
			datapoint.XValue = (System.IComparable)NSObject.FromObject(date);
