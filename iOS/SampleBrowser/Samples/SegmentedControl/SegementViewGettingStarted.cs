...
namespace SampleBrowser
{
    public class SegementViewGettingStarted : SampleView
    {
        ...
        private void AddCollection()
        {
            ...
            {
                new SfSegmentItem(){IconFont = "A",  FontIconFontColor=UIColor.FromRGB(35,58,126), },
                new SfSegmentItem(){IconFont = "A",  FontIconFontColor=UIColor.FromRGB(126,129,136), },
                new SfSegmentItem(){IconFont = "A",  FontIconFontColor=UIColor.FromRGB(41,38,57), },
                new SfSegmentItem(){IconFont = "A",  FontIconFontColor=UIColor.FromRGB(17,117,109), },
                new SfSegmentItem(){IconFont = "A",  FontIconFontColor=UIColor.FromRGB(110,0,34), },
            };
