    ...
    public class MaskedEdit_Tablet : SampleView
    {
        ...
        public override void LayoutSubviews()
        {
            ...
            foreach (var view in this.Subviews)
            {
                ...
                cultureLabel.Frame = new CGRect(110, 45, 200, 30);
                cultureButton.Frame = new CGRect(340, 45, contentView.Frame.Size.Width - 520, 30);
                ...
                visibilityLabel.Frame = new CGRect(110, 80, 200, 30);
                visibilityButton.Frame = new CGRect(340, 80, contentView.Frame.Size.Width - 520, 30);
                visibilityPicker.Frame = new CGRect(100, 20, contentView.Frame.Size.Width - 200, 200);
                visibilityDoneButton.Frame = new CGRect(100, 20, contentView.Frame.Size.Width - 200, 30);

                promptcharLabel.Frame = new CGRect(110, 115, 200, 30);
                promptcharButton.Frame = new CGRect(340, 115, contentView.Frame.Size.Width - 520, 30);
                ...
                hidepromptLabel.Frame = new CGRect(110, 150, 200, 30);
                hidepromptSwitch.Frame = new CGRect(340, 150, contentView.Frame.Size.Width - 520, 30);
        ...
        public void mainPageDesign()
        {
            ...
            visibilityLabel.Font = UIFont.FromName("Helvetica", 16f);
        ...
        public void optionView()
        {
            ...
            contentView.AddSubview(visibilityPicker);
            contentView.AddSubview(visibilityDoneButton);
