...
namespace SampleBrowser
{
    public partial class DigitalSignature : SampleView
    {
        ...
        void LoadAllowedTextsLabel()
        {
            ...
            label1.Text = "This sample demonstrates how a PDF document can be secured with certificates and signed with either standard or author signatures. Now added the support for Elliptic Curve Digital Signature Algorithm (ECDSA) to sign the PDF document.";
            ...
            if (UIDevice.CurrentDevice.UserInterfaceIdiom == UIUserInterfaceIdiom.Pad)
            {
                ...
                label1.Frame = new CGRect(0, 12, frameRect.Location.X + frameRect.Size.Width, 120);
            }
            else
            {
                label1.Frame = new CGRect(frameRect.Location.X, 12, frameRect.Size.Width, 120);
