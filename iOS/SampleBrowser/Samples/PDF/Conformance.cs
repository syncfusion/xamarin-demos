...
namespace SampleBrowser
{
    public partial class Conformance : SampleView
    {
        ...
        public Conformance()
        {
			this.layoutList.Add((NSString)"PDF/A-1a");
            this.layoutList.Add((NSString)"PDF/A-1b");
            this.layoutList.Add((NSString)"PDF/A-2a");
			this.layoutList.Add((NSString)"PDF/A-2b");
			this.layoutList.Add((NSString)"PDF/A-2u");
			this.layoutList.Add((NSString)"PDF/A-3a");
			this.layoutList.Add((NSString)"PDF/A-3b");
			this.layoutList.Add((NSString)"PDF/A-3u");
            label1 = new UILabel();
        ...
        {   
            ...
            label2 = new UILabel()
            {
                Text = "Please select the conformance",
            ...
            if (UIDevice.CurrentDevice.UserInterfaceIdiom == UIUserInterfaceIdiom.Pad)
            {
                ...
                label2.Frame = new CGRect(0, 60, frameRect.Location.X + frameRect.Size.Width, 50);
            }
            else {
                label1.Frame = new CGRect(frameRect.Location.X, 12, frameRect.Size.Width, 50);
                label2.Frame = new CGRect(frameRect.Location.X,60, frameRect.Size.Width, 50);
            }
            ...
            if (UIDevice.CurrentDevice.UserInterfaceIdiom == UIUserInterfaceIdiom.Pad)
            {
                button.Frame = new CGRect(0, 170, frameRect.Location.X + frameRect.Size.Width, 10);
            }
            else {
                button.Frame = new CGRect(frameRect.Location.X, 170, frameRect.Size.Width, 10);
