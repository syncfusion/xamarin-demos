...
namespace SampleBrowser
{
	public class ChartViewModel
	{
        ...
        public ObservableCollection<ChartDataModel> BoxAndWhiskerData { get; set; }

        public ObservableCollection<ChartDataModel> ErrorBarData { get; set; }
		...
		public ChartViewModel()
		{
			...
			TechnicalIndicatorData = new ObservableCollection<ChartDataModel>
		   {
            ...
            BoxAndWhiskerData = new ObservableCollection<ChartDataModel>
            {
            ...
            ErrorBarData = new ObservableCollection<ChartDataModel>
            {
        ...
        public static ObservableCollection<ChartDataModel> GetTrendlineDataSource1()
        {
            ...
            DateTime date = new DateTime(1977, 01, 02);
            var datas = new ObservableCollection<ChartDataModel>();
            foreach (var y in yValue)
            {
                datas.Add(new ChartDataModel(date, y));
        ...
        {
            var powerData = new ObservableCollection<ChartDataModel>();
            powerData.Add(new ChartDataModel(1, 10));
            powerData.Add(new ChartDataModel(2, 50));
            powerData.Add(new ChartDataModel(3, 80));
            powerData.Add(new ChartDataModel(4, 110));
            powerData.Add(new ChartDataModel(5, 180));
            powerData.Add(new ChartDataModel(6, 220));
            powerData.Add(new ChartDataModel(7, 300));
            powerData.Add(new ChartDataModel(8, 370));
            powerData.Add(new ChartDataModel(9, 490));
            powerData.Add(new ChartDataModel(10, 500));
