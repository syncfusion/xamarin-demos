		...
		public override void LayoutSubviews ()
		{
			foreach (var view in this.Subviews) {
...

                {
                    ...
                    picker_calendarView.Frame = new CGRect(0, 160, 300, 70);
                    doneButton.Frame = new CGRect(0, 100, 300, 40);

                    label_calendarView.Frame = new CGRect(10, 20, this.Frame.Size.Width - 20, 30);

                    button_calendarView.Frame = new CGRect(10, 80, 300, 30);
                }
                else
                {
