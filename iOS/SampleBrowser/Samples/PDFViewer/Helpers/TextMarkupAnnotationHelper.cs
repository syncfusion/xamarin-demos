        ...
        internal void ColorButton_TouchUpInside(object sender, EventArgs e)
        {
            ...
            if (!parent.isColorSelected)
            {
                ...
                if (parent.isOpacityNeeded)
                {
                    ...
                    parent.whiteButton.Frame = new CGRect(parent.parentView.Frame.Width - 350, 7, 30, 30);
                    if (parent.annotation is InkAnnotation || parent.pdfViewerControl.AnnotationMode == AnnotationMode.Ink || parent.annotation is ShapeAnnotation || parent.pdfViewerControl.AnnotationMode == AnnotationMode.Rectangle
