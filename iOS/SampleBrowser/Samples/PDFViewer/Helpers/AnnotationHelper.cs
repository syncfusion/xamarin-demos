        ...
        internal void AnnotationButton_TouchUpInside(object sender, EventArgs e)
        {
            ...
            if (!parent.isAnnotationToolbarVisible)
            {
                ...
                if ((UIDevice.CurrentDevice).UserInterfaceIdiom == UIUserInterfaceIdiom.Pad)
                    parent.textMarkupAnnotationButton.Frame = new CGRect((parent.annotationToolbar.Frame.Width - 250) / 2, 7, 35, 35);
                else
                    parent.textMarkupAnnotationButton.Frame = new CGRect(40, 7, 35, 35);
                ...
                if ((UIDevice.CurrentDevice).UserInterfaceIdiom == UIUserInterfaceIdiom.Pad)
                    parent.inkAnnotationButton.Frame = new CGRect((parent.annotationToolbar.Frame.Width + 100) / 2, 7, 35, 35);
                else
                    parent.inkAnnotationButton.Frame = new CGRect(180, 7, 35, 35);
                ...
                if ((UIDevice.CurrentDevice).UserInterfaceIdiom == UIUserInterfaceIdiom.Pad)
                    parent.editTextAnnotationButton.Frame = new CGRect((parent.annotationToolbar.Frame.Width - 250), 7, 35, 35);
                else
                    parent.editTextAnnotationButton.Frame = new CGRect((250), 7, 35, 35);
                ...
                if ((UIDevice.CurrentDevice).UserInterfaceIdiom == UIUserInterfaceIdiom.Pad)
                    parent.shapeAnnotationButton.Frame = new CGRect((parent.annotationToolbar.Frame.Width - 100) / 2, 7, 35, 35);
                else
                    parent.shapeAnnotationButton.Frame = new CGRect(110, 7, 35, 35);
