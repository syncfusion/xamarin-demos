...
namespace SampleBrowser
{
    public class ProfileEditor : SampleView
    {
        ...
        private UIView CreateView(UIView detailsView, int index)
        {
            ...
            name.Font = UIDevice.CurrentDevice.UserInterfaceIdiom == UIUserInterfaceIdiom.Pad ? UIFont.SystemFontOfSize(20) : UIFont.SystemFontOfSize(12);
            ...
            profileName.Font = UIDevice.CurrentDevice.UserInterfaceIdiom == UIUserInterfaceIdiom.Pad ? UIFont.SystemFontOfSize(24) : UIFont.SystemFontOfSize(12);
