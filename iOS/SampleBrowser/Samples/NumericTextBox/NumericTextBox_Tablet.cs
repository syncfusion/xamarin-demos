...
namespace SampleBrowser
{
	public class NumericTextBox_Tablet : SampleView
	{
		...
		UILabel titleLabel, descriptionLabel, formulaLabel, principalLabel, interestRateLabel, termLabel, interestLabel, cultureLabel, allowNullLabel, propertiesLabel, allowDefaultDecimal;
		...
		public override void LayoutSubviews()
		{
			foreach (var view in this.Subviews)
			{
				...
				principalNumericTextBox.Frame = new CGRect(15, 170, controlView.Frame.Width - 320, 40);
				interestRateNumericTextBox.Frame = new CGRect(15, 250, controlView.Frame.Width - 320, 40);
				periodNumericTextBox.Frame = new CGRect(15, 330, controlView.Frame.Width - 320, 40);
				outputNumericTextBox.Frame = new CGRect(15, 410, controlView.Frame.Width - 320, 40);
				titleLabel.Frame = new CGRect(15, 10, controlView.Frame.Size.Width - 20, 50);
				descriptionLabel.Frame = new CGRect(15, 70, controlView.Frame.Size.Width - 20, 30);
				formulaLabel.Frame = new CGRect(15, 100, controlView.Frame.Size.Width - 20, 30);
				principalLabel.Frame = new CGRect(15, 140, controlView.Frame.Size.Width - 20, 30);
				interestRateLabel.Frame = new CGRect(15, 220, controlView.Frame.Size.Width - 20, 30);
				termLabel.Frame = new CGRect(15, 300, controlView.Frame.Size.Width - 20, 30);
				interestLabel.Frame = new CGRect(15, 380, controlView.Frame.Size.Width - 20, 30);
		...
		public void mainPageDesign()
		{
			...
			titleLabel.Font = UIFont.FromName("Helvetica-Bold", 22f);
			...
			formulaLabel.Font = UIFont.ItalicSystemFontOfSize(16f);
		...
		public void loadOptionView()
		{
			...
			contentView.AddSubview(allowDefaultDecimal);

			//allowDecimalSwitchh
			allowDecimalSwitch = new UISwitch();
			allowDecimalSwitch.ValueChanged += AllowDecimalSwitch_ValueChanged;
			allowDecimalSwitch.On = false;
			contentView.AddSubview(allowDecimalSwitch);
