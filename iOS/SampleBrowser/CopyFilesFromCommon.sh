...
cp $ESPath/essentialstudio-common/Data/DocIO/BkmkDocumentPart_Template.docx $ProjectPath/Samples/DocIO/Templates/
cp $ESPath/essentialstudio-common/Data/DocIO/Bookmark_Template.docx $ProjectPath/Samples/DocIO/Templates/
...
cp "$ESPath/essentialstudio-common/Data/DocIO/CreateEquation.docx" $ProjectPath/Samples/DocIO/Templates/
...
cp "$ESPath/essentialstudio-common/Data/DocIO/Security Settings.docx" $ProjectPath/Samples/DocIO/Templates/
cp "$ESPath/essentialstudio-common/Data/DocIO/TrackChangesTemplate.docx" $ProjectPath/Samples/DocIO/Templates/
...
cp $ESPath/essentialstudio-common/Data/Presentation/OleTemplate.docx $ProjectPath/Samples/Presentation/Templates/
cp $ESPath/essentialstudio-common/Data/Presentation/OlePicture.png $ProjectPath/Samples/Presentation/Templates/
cp $ESPath/essentialstudio-common/Data/Presentation/EmbeddedOleObject.pptx $ProjectPath/Samples/Presentation/Templates/
...
cp $ESPath/essentialstudio-common/Data/XlsIO/ExcelToJSON.xlsx $ProjectPath/Samples/XlsIO/Template/
