...
namespace SampleBrowser
{
    public partial class TrackChanges : SampleView
    {
        ...
        void LoadAllowedTextsLabel()
        {
            ...
            {
                radioGroup.Frame = new CGRect(5, 65, frameRect.Width, 40);
            }
            ...
            {
                viewButton.Frame = new CGRect(0, 120, frameRect.Location.X + frameRect.Size.Width, 10);
            }
            ...
            {
                generateButton.Frame = new CGRect(0, 150, frameRect.Location.X + frameRect.Size.Width, 10);
            }
