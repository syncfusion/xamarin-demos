    ...
    public class MaskedEdit_Mobile : SampleView
    {
        ...
        public override void LayoutSubviews()
        {
            ...
            foreach (var view in this.Subviews)
            {
                ...
                validationButton.Frame = new CGRect(10, 55, this.Frame.Size.Width - 20, 40);
                cutCopyPicker.Frame = new CGRect(10, 260, this.Frame.Size.Width, 100);
                validationDoneButton.Frame = new CGRect(10, 245, this.Frame.Size.Width - 20, 40);

                cultureLabel.Frame = new CGRect(10, 85, this.Frame.Size.Width - 20, 40);
                cultureButton.Frame = new CGRect(10, 120, this.Frame.Size.Width - 20, 40);
                culturePicker.Frame = new CGRect(10, 260, this.Frame.Size.Width, 100);
                cultureDoneButton.Frame = new CGRect(10, 245, this.Frame.Size.Width - 20, 40);

                hidepromptLabel.Frame = new CGRect(10, 160, this.Frame.Size.Width - 20, 40);
                hidepromptSwitch.Frame = new CGRect(250, 165, this.Frame.Size.Width - 20, 40);

                promptcharLabel.Frame = new CGRect(10, 195, this.Frame.Size.Width - 20, 40);
                promptcharButton.Frame = new CGRect(200, 200, this.Frame.Size.Width - 215, 40);
                promptPicker.Frame = new CGRect(10, 260, this.Frame.Size.Width, 100);
                promptDoneButton.Frame = new CGRect(10, 245, this.Frame.Size.Width - 20, 40);
