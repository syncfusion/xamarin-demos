...
namespace SampleBrowser
{
    public class CustomToolbar : SampleView
    {
        ...
        internal UITextField pageNumberField = new UITextField();
        internal UILabel totalPageLabel = new UILabel();
        internal UIButton undoButton = new UIButton();
        internal UIButton redoButton = new UIButton();
        internal UISearchBar searchBar = new UISearchBar();
        internal UIButton searchButton = new UIButton();
        internal UIButton backButton = new UIButton();
        internal UIButton searchNextButton = new UIButton();
        internal UIButton searchPreviousButton = new UIButton();
        internal UIButton fileButton = new UIButton();
        ...
        internal ActivityIndicator activityDialog;
        internal DropDownMenu dropDownMenu;
        internal UIAlertView popUpAlertView;
        internal Stream fileStream;
        internal UIView bottomToolBar = new UIView();
        internal UIButton annotationButton = new UIButton();
        ...
        internal UIButton saveButton = new UIButton();
        ...
        internal UIAlertView pagePopupView = new UIAlertView();
