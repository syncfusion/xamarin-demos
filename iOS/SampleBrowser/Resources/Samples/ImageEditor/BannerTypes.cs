...
namespace SampleBrowser
{
	public class BannerTypes : SampleView
	{
		...
		public override void LayoutSubviews()
		{
			...
			UIButton imageView1 = new UIButton(new CGRect(padding, 100, (TotalWidth / 3) - padding, 150));
			...
			UIButton imageView2 = new UIButton(new CGRect((TotalWidth / 3) + (1 * padding), 100, (TotalWidth / 3) - padding, 150));
			...
			UIButton imageView3 = new UIButton(new CGRect((2 * (TotalWidth / 3)) + (1 * padding), 100, (TotalWidth / 3) - padding, 150));
