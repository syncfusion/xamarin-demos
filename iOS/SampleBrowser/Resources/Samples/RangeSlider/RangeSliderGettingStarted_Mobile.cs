...
namespace SampleBrowser
{
	public class RangeSliderGettingStarted_Mobile : SampleView
	{
		...
		public RangeSliderGettingStarted_Mobile ()
		{
			...
			rangeSlider1.Delegate = new RangeSliderMobileDelegate();
			...
			rangeSlider2.Delegate = new RangeSliderMobileDelegate();
		...
		public class RangeSliderMobileDelegate:SFRangeSliderDelegate
		{
			public override void RangeValueChange (SFRangeSlider SFRangeSlider, nfloat start, nfloat end)
			{
				(SFRangeSlider.Superview as RangeSliderGettingStarted_Mobile).SetValue (SFRangeSlider, start, end);
			}
		}
	}
}