...
namespace SampleBrowser
{
	public class Rating_Mobile : SampleView
	{
		...
		public Rating_Mobile()
		{
			...
			rating1.Delegate = new RatingControlMobileDelegate();
	...
	public class RatingControlMobileDelegate:SFRatingDelegate
	{
		public override void DidValueChanged (SFRating sfRating, nfloat value)
		{
			(sfRating.Superview as Rating_Mobile).SetValue (value);
		}
	}
}