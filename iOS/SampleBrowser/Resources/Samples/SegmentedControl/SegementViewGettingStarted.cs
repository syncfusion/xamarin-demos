...
namespace SampleBrowser
{
    public class SegementViewGettingStarted : SampleView
    {
        ...
        private void AddCollection()
        {
            ...
            UIFont colorfontFamily = UIFont.FromName(string.Empty, 32f);
            ...
            {
                new SfSegmentItem(){IconFont = "\uE91F",  FontIconFontColor=UIColor.FromRGB(50,49,142), Text="Square",Font=UIFont.SystemFontOfSize(32), },
                new SfSegmentItem(){IconFont = "\uE91F",  FontIconFontColor=UIColor.FromRGB(47,125,192), Text="Square",Font=UIFont.SystemFontOfSize(32), },
                new SfSegmentItem(){IconFont = "\uE91F",  FontIconFontColor=UIColor.FromRGB(149,51,118), Text="Square",Font=UIFont.SystemFontOfSize(32), },
                new SfSegmentItem(){IconFont = "\uE91F",  FontIconFontColor=UIColor.FromRGB(179,63,63), Text="Square",Font=UIFont.SystemFontOfSize(32), },
                new SfSegmentItem(){IconFont = "\uE91F",  FontIconFontColor=UIColor.FromRGB(241,151,63), Text="Square",Font=UIFont.SystemFontOfSize(32),},
                new SfSegmentItem(){IconFont = "\uE91F",  FontIconFontColor=UIColor.FromRGB(201,214,86), Text="Square",Font=UIFont.SystemFontOfSize(32), },
                new SfSegmentItem(){IconFont = "\uE91F",  FontIconFontColor=UIColor.FromRGB(0,141,127), Text="Square",Font=UIFont.SystemFontOfSize(32), },
            };
        }
