...
namespace SampleBrowser
{
	public class ContextualMenu : SampleView
	{
		...
		void gPlus_ItemTapped(object sender, RadialMenuEventArgs e)
		{
			alertWindow.Message = "Shared in Google+";
			alertWindow.Show();
		}
		void twitter_ItemTapped(object sender, RadialMenuEventArgs e)
		{
			alertWindow.Message = "Shared in Twitter";
			alertWindow.Show();
		}
		void pinterest_ItemTapped(object sender, RadialMenuEventArgs e)
		{
			alertWindow.Message = "Shared in Pinterest";
			alertWindow.Show();
		}
		void linkedIn_ItemTapped(object sender, RadialMenuEventArgs e)
		{
			alertWindow.Message = "Shared in LinkedIn";
			alertWindow.Show();
		}
		void instagram_ItemTapped(object sender, RadialMenuEventArgs e)
		{
