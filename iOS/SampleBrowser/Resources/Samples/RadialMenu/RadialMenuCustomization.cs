...
namespace SampleBrowser
{
	public class RadialMenuCustomization : SampleView
	{
		...
		void Pen_ItemTapped(object sender, RadialMenuEventArgs e)
		{
			isEraserSelected = false;
		...
		void Brush_ItemTapped(object sender, RadialMenuEventArgs e)
		{
			isEraserSelected = false;
		...
		void Remove_ItemTapped(object sender, RadialMenuEventArgs e)
		{
			isEraserSelected = false;
			drawingTool.Clear();
		...
		void Paint_ItemTapped(object sender, RadialMenuEventArgs e)
		{
			isEraserSelected = false;
		...
		void PaintBox_ItemTapped(object sender, RadialMenuEventArgs e)
		{
			isEraserSelected = false;
		...
		void Eraser_ItemTapped(object sender, RadialMenuEventArgs e)
		{
