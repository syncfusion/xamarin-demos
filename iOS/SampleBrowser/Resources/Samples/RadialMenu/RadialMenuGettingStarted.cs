...
namespace SampleBrowser
{
	public class RadialMenuGettingStarted : SampleView
	{
		...
		public RadialMenuGettingStarted()
		{
			...
			radialMenu.CenterButtonIconFont = UIFont.FromName(string.Empty, 30);
			...
			if ((UIDevice.CurrentDevice).UserInterfaceIdiom == UIUserInterfaceIdiom.Pad)
			{
				...
				radialMenu.CenterButtonIconFont = UIFont.FromName(string.Empty, 60);
			}
			...
			for (int i = 0; i < 6; i++)
			{
				SfRadialMenuItem item = new SfRadialMenuItem() {IconFont = UIFont.FromName(string.Empty,20), FontIcon=layer[i]};
				item.ItemTapped+= Item_ItemTapped;
				if ((UIDevice.CurrentDevice).UserInterfaceIdiom == UIUserInterfaceIdiom.Pad)
					item.IconFont = UIFont.FromName(string.Empty, 30);
				item.Tag = 100 + i;
				radialMenu.Items.Add(item);
			}
			for (int i = 0; i < 4; i++)
			{
				SfRadialMenuItem item = new SfRadialMenuItem() { IconFont = UIFont.FromName(string.Empty, 20), FontIcon = wifi[i] };
			...
			for (int i = 0; i < 3; i++)
			{
				SfRadialMenuItem item = new SfRadialMenuItem() { IconFont = UIFont.FromName(string.Empty, 20), FontIcon = profile[i] };
			...
			for (int i = 0; i < 3; i++)
			{
				SfRadialMenuItem item = new SfRadialMenuItem() { IconFont = UIFont.FromName(string.Empty, 20), FontIcon = brightness[i] };
			...
			for (int i = 0; i < 3; i++)
			{
				SfRadialMenuItem item = new SfRadialMenuItem() { IconFont = UIFont.FromName(string.Empty, 20), FontIcon = battery[i] };
				item.ItemTapped += Item_ItemTapped5;
				radialMenu.Items[4].Items.Add(item);
			}
			for (int i = 0; i < 3; i++)
			{
				SfRadialMenuItem item = new SfRadialMenuItem() { IconFont = UIFont.FromName(string.Empty, 20), FontIcon = power[i] };
		...
		void Item_ItemTapped(object sender, RadialMenuEventArgs e)
		{
			if (i > 99)
			{
				i = 0;
		...
		void Item_ItemTapped1(object sender, RadialMenuEventArgs e)
		{
			if (i > 99)
			{
				i = 0;
		...
		void Item_ItemTapped2(object sender, RadialMenuEventArgs e)
		{
			if (i > 99)
			{
				i = 0;
		...
		void Item_ItemTapped3(object sender, RadialMenuEventArgs e)
		{
			if (i > 99)
			{
				i = 0;
		...
		void Item_ItemTapped4(object sender, RadialMenuEventArgs e)
		{
			if (i > 99)
			{
				i = 0;
		...
		void Item_ItemTapped5(object sender, RadialMenuEventArgs e)
		{
			if (i > 99)
			{
				i = 0;
		...
		void Item_ItemTapped6(object sender, RadialMenuEventArgs e)
		{
			if (i > 99)
			{
				i = 0;
