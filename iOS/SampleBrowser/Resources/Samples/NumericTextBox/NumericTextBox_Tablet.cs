...
namespace SampleBrowser
{
	public class NumericTextBox_Tablet : SampleView
	{
		...
		public void loadOptionView()
		{
			...
			culturePickermodel.PickerChanged += (sender, e) =>
			{
				...
				{
					principalNumericTextBox.CultureInfo = new NSLocale("jp_JP");
					interestRateNumericTextBox.CultureInfo = new NSLocale("jp_JP");
					periodNumericTextBox.CultureInfo = new NSLocale("jp_JP");
					outputNumericTextBox.CultureInfo = new NSLocale("jp_JP");
				}
		...
		{
			outputNumericTextBox.Value = principalNumericTextBox.Value * interestRateNumericTextBox.Value * periodNumericTextBox.Value;
	...
	public class NumericTextBoxTabletDelegate:SFNumericTextBoxDelegate
	{
		public override void ValueChange (SFNumericTextBox SFNumericTextBox, nfloat value)
		{
			(SFNumericTextBox.Superview.Superview as NumericTextBox_Tablet).SetValue ();
		}
	}
