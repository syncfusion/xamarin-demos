	...
	public class ChartViewModel
	{
		...
		public ChartViewModel()
		{
			...
			TechnicalIndicatorData = new ObservableCollection<ChartDataModel>
		   {
            ...
            {
                new ChartDataModel("Development", new List<double>{22, 22, 23, 25, 25, 25, 26, 27, 27, 28, 28, 29, 30, 32, 34, 32, 34, 36, 35, 38, 42, 45, 44 }),
                new ChartDataModel("Test", new List<double>{ 22, 33, 23, 25, 26, 28, 29, 30, 34, 33, 32, 31, 50 } ),
                new ChartDataModel("HR", new List<double>{ 22, 24, 25, 30, 32, 34, 36, 38, 39, 41, 35, 36, 40, 45, 50 }),
                new ChartDataModel("Finance", new List<double>{ 26, 27, 28, 30, 32, 34, 35, 37, 35, 37, 45, 52, 53 } ),
                new ChartDataModel("Sales", new List<double>{ 26, 27, 29, 32, 34, 35, 36, 37, 38, 39, 41, 43 }),
            };
            ...
            ErrorBarData = new ObservableCollection<ChartDataModel>
            {
                ...
                new ChartDataModel("DUE", 28, 2, 0.5),
