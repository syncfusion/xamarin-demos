xcopy /s /y ..\essentialstudio-common\Data\DocIO\BkmkDocumentPart_Template.doc Samples\DocIO\Templates\
xcopy /s /y ..\essentialstudio-common\Data\DocIO\Bookmark_Template.doc Samples\DocIO\Templates\
...
xcopy /s /y ..\essentialstudio-common\Data\XlsIO\BusinessObjects.xml Samples\XlsIO\Template\
