The `SfBusyIndicator` control makes it easy to let the user know when an application is busy. It is used to indicate busy status during app loading, data processing etc.
