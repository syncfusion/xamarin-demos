...
namespace SampleBrowser
{
    public class Serialization : SamplePage
    {
        ...
        public override Android.Views.View GetSampleContent(Android.Content.Context context)
        {
            ...
            {
                gridview.LayoutParameters=new LinearLayout.LayoutParams(LinearLayout.LayoutParams.FillParent, 650);
                gridview.NumColumns = 3;
            }
            else if(deviceDensity>=3 && deviceDensity<4 && !IsTabletDevice(context))
            {
                gridview.LayoutParameters = new LinearLayout.LayoutParams(LinearLayout.LayoutParams.FillParent, 310 * deviceDensity);
            }
            else if(deviceDensity < 3 && !IsTabletDevice(context))
            {
                gridview.LayoutParameters = new LinearLayout.LayoutParams(LinearLayout.LayoutParams.FillParent, 400 * deviceDensity);
