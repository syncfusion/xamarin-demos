    ...
    public class ImageEditor : SamplePage
    {
        ...
        public class SfImageEditorActivity : Activity
        {
            ...
            protected override void OnCreate(Bundle savedInstanceState)
            {
                ...
                editor.ToolbarSettings.VisibleShapesItems = ImageEditorShapes.Rectangle | ImageEditorShapes.Circle | ImageEditorShapes.Arrow | ImageEditorShapes.Line | ImageEditorShapes.DoubleArrow | ImageEditorShapes.Dotted |
