...
namespace SampleBrowser
{
    public class TemplateView : LinearLayout
    {
        ...
        protected override void OnLayout(bool changed, int l, int t, int r, int b)
        {
            ...
            var measuredheight = (int)(40 * density);
            this.label1.Layout(0, 0, this.Width-measuredwidth, measuredheight);
            this.label2.Layout(this.Width-measuredwidth, padding, this.Width- padding, measuredheight- padding);
		}
        #endregion
    }
}