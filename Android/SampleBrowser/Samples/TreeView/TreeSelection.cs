...
{
    public class TreeSelection : SamplePage
    {
        SfTreeView treeView;
        ...
        public override Android.Views.View GetPropertyWindowLayout(Android.Content.Context context)
        {
            ...
            ArrayAdapter<String> dataAdapter = new ArrayAdapter<String>
                (context, Android.Resource.Layout.SimpleSpinnerDropDownItem, adapter);
        ...
        void Spin_ItemSelected(object sender, AdapterView.ItemSelectedEventArgs e)
        {
            if (e.Position == 0)
