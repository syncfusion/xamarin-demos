...
namespace SampleBrowser
{
    ...
    public class CustomToolBarPdfViewerDemo : SamplePage
    {
        ...
        internal Android.Telephony.TelephonyManager manager;
        ...
        public override View GetSampleContent(Context context)
        {
            ...
            manager = (Android.Telephony.TelephonyManager)context.GetSystemService(Context.TelephonyService) as Android.Telephony.TelephonyManager;
            if (IsDeviceTablet)
            {
        ...
        private void Popup_MenuItemClick(object sender, PopupMenu.MenuItemClickEventArgs e)
        {
            ...
            if (documentName != backupDocumentName)
            {
                ...
                bookmarkToolbar.bookmarkLoadedDocument = new PdfLoadedDocument(docStream);
				//Populate the bookmark elements of the new PDF on the ListView
                bookmarkToolbar.PopulateInitialBookmarkList();
                pdfViewerControl.LoadDocument(docStream);
