...
namespace SampleBrowser
{
    ...
    public class CustomToolBarPdfViewerDemo : SamplePage
    {
        ...
        private async void MenuOptions_TextSelectionMenuItemClicked(object sender, EventArgs e)
        {
            if ((sender as TextSelectionMenuItem).Id == "find")
            {
                String escapedQuery = Java.Net.URLEncoder.Encode(this.selectedText, "UTF-8");
