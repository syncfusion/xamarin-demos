...
namespace SampleBrowser
{
    ...
    public class Data
    {
        ...
        {
            var datas = new List<DataPoint>();
            datas.Add(new DataPoint("GER", 72));
            datas.Add(new DataPoint("RUS", 103.1));
            datas.Add(new DataPoint("BRZ", 139.1));
            datas.Add(new DataPoint("IND", 462.1));
            datas.Add(new DataPoint("CHN", 721.4));
            datas.Add(new DataPoint("USA", 286.9));
            datas.Add(new DataPoint("GBR", 115.1));
            datas.Add(new DataPoint("NGR", 97.2));
            return datas;
        }
