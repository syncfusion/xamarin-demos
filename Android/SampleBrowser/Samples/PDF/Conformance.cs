...
namespace SampleBrowser
{
    public partial class Conformance : SamplePage
    {
        ...
        public override View GetSampleContent(Context con)
        {
            ...
            text2.Text = "This sample demonstrates various PDF conformance support in Essential PDF. Essential PDF provides support for PDF/A-1b, PDF/A-2b and PDF/A-3b conformance.";
            ...
            string[] list1 = { "PDF/A-1b", "PDF/A-2b", "PDF/A-3b"};
