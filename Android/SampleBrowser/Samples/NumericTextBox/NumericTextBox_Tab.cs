...
namespace SampleBrowser
{
    public class NumericTextBox_Tab : SamplePage
    {
        ...
        bool allownull = true, allowDefaultDecimalDigits= true;
        int culturePosition = 0, numerHeight, width;
        bool allowNullPosition = true, allowDefaultDecimalDigitsPosition = true;
        ...
        public void ApplyChanges()
        {
            ...
            principalAmountNumericTextBox.AllowDefaultDecimalDigits = allowDefaultDecimalDigits;
            interestNumericTextBox.AllowDefaultDecimalDigits = allowDefaultDecimalDigits;
        }
        ...
        private void CultureLayout()
        {
            ...
            spaceText2.LayoutParameters = new FrameLayout.LayoutParams(ViewGroup.LayoutParams.MatchParent, (int)(totalHeight * 0.05), GravityFlags.Center);
        ...
        private void AllowDefaultDecimalDigitsLayout()
        {
            //AllowDefaultDecimalDigits
            TextView allowDefaultDecimalDigitsText = new TextView(context);
            allowDefaultDecimalDigitsText.LayoutParameters = new FrameLayout.LayoutParams((int)(totalWidth * 0.33), ViewGroup.LayoutParams.WrapContent, GravityFlags.Center);
            allowDefaultDecimalDigitsText.Text = "Allow Default Decimal Digits";
            allowDefaultDecimalDigitsText.TextSize = 15;

            Switch allowDefaultDecimalDigitsCheckBox = new Switch(context);
            allowDefaultDecimalDigitsCheckBox.Gravity = GravityFlags.Left;
            allowDefaultDecimalDigitsCheckBox.Checked = allowDefaultDecimalDigitsPosition;
            allowDefaultDecimalDigitsCheckBox.CheckedChange += (object send, CompoundButton.CheckedChangeEventArgs eve) => {
                ...
                allowDefaultDecimalDigitsPosition = allowDefaultDecimalDigits;
                ApplyChanges();
            };

            //spaceText
            TextView spaceText = new TextView(context);
            spaceText.LayoutParameters = new FrameLayout.LayoutParams((int)(totalWidth * 0.167), ViewGroup.LayoutParams.WrapContent, GravityFlags.Center);

            LinearLayout allowDefaultDecimalDigitsLayout = new LinearLayout(context);
            allowDefaultDecimalDigitsLayout.Orientation = Android.Widget.Orientation.Horizontal;
            allowDefaultDecimalDigitsLayout.AddView(allowDefaultDecimalDigitsText);
            allowDefaultDecimalDigitsLayout.AddView(allowDefaultDecimalDigitsCheckBox);
            allowDefaultDecimalDigitsLayout.AddView(spaceText);

            proprtyOptionsLayout.AddView(allowDefaultDecimalDigitsLayout);
