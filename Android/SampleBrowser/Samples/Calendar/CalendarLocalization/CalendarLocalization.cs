...
{
    public class CalendarLocalization : SamplePage, IDisposable
    {
        private CalendarLocalization_Mobile mobile;
        private CalendarLocalization_Tab tab;
        private Context tabletcontext;
        ...
        public override View GetSampleContent(Android.Content.Context con)
        {
            ...
            {
                tab = new CalendarLocalization_Tab();
                tabletcontext = con;
                return tab.GetSampleContent(con);
            }
            else
            {
                mobile = new CalendarLocalization_Mobile();
        ...
        {
            base.OnApplyChanges();
            if (!IsTabletDevice(tabletcontext))
            {
