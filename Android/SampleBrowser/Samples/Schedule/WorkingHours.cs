...
namespace SampleBrowser
{
    ...
    public class Timetable : SamplePage
    {
        ...
        public override View GetSampleContent(Context context)
        {
            ...
            if (ScheduleCustomHeader.IsTabletDevice(mContext))
                sfschedule.TimeIntervalHeight = 175;
            else
                sfschedule.TimeIntervalHeight = 130;
        ...
        void Sfschedule_VisibleDatesChanged(object sender, VisibleDatesChangedEventArgs e)
        {
