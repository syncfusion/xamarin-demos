...
namespace SampleBrowser
{
    ...
    public class DetailsView : SamplePage
    {
        ...
        {
            Toast.MakeText(context, "Contact blocked", ToastLength.Short).Show();
        }

        private void Label1_Click(object sender, EventArgs e)
        {
            Toast.MakeText(context, "Message sent", ToastLength.Short).Show();
        }

        private void Label3_Click(object sender, EventArgs e)
        {
            Toast.MakeText(context, "No outgoing call history", ToastLength.Short).Show();
        }
