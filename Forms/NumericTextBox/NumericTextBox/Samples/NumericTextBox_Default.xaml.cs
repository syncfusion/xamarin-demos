    ...
    public partial class NumericTextBox_Default : SampleView
    {
        ...
        public void trimValue()
        {
            if (principalNumericTextBox.Value != null)
            {
                ...
                {
                    if (principalNumericTextBox.Value.ToString().Length < 8 && interestRateNumericTextBox.Value.ToString().Length < 8 && termNumericTextBox.Value.ToString().Length < 8)
                    {
