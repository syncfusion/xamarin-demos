...
namespace SampleBrowser.SfNumericTextBox
{
    public partial class NumericTextBox_Default : SampleView
    {
        ...
        public void OptionView()
        {
            ...
            //Toggle button
            allowDefaultDecimalDigitsToggle.Toggled += AllowDefaultDecimalDigitsToggle_Toggled;
            ...
            if (Device.RuntimePlatform == Device.iOS)
            {
                ...
                allowDefaultDecimalDigitsLabel.WidthRequest = width / 2;
                allowDefaultDecimalDigitsLabel.VerticalOptions = LayoutOptions.End;
                allowNullToggle.VerticalOptions = LayoutOptions.Start;
                allowDefaultDecimalDigitsToggle.VerticalOptions = LayoutOptions.Start;
            ...
            else if (Device.RuntimePlatform == Device.UWP && Device.Idiom == TargetIdiom.Phone)
            {
                ...
                allowDefaultDecimalDigitsToggle.WidthRequest = width / 2;
                allowDefaultDecimalDigitsToggle.HorizontalOptions = LayoutOptions.End;
            ...
            {
                autoDecimalLabelColumn.Width = new GridLength(1, GridUnitType.Star);
                autoDecimalToggleColumn.Width = new GridLength(0, GridUnitType.Auto);
            }
            else if (Device.RuntimePlatform == Device.UWP)
            {
                ...
                if (Device.Idiom == TargetIdiom.Desktop)
                {
                    ...
                    autoDecimalLabelColumn.Width = new GridLength(200.0, GridUnitType.Absolute);
                    allowNullToggle.HorizontalOptions = LayoutOptions.Start;
                    allowDefaultDecimalDigitsToggle.HorizontalOptions = LayoutOptions.Start;
        ...
        private void AllowDefaultDecimalDigitsToggle_Toggled(object sender, ToggledEventArgs e)
        {
            principalNumericTextBox.AllowDefaultDecimalDigits = e.Value;
            interestRateNumericTextBox.AllowDefaultDecimalDigits = e.Value;
        }
