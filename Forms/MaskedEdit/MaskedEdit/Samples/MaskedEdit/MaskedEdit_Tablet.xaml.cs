...
{
    public partial class MaskedEdit_Tablet : SampleView
    {
        ...
        public void OptionView()
        {
            ...
            if (Device.RuntimePlatform == Device.iOS)
            {
                ...
                optionLayout.Margin = new Thickness(10, 30, 0, 30);
                gridOption.Margin = new Thickness(0, 20, 0, 0);
                optionLayout.Spacing = 30;
                gridOption.RowSpacing = 30;
                gridOption.Margin = new Thickness(0,0,0,10);
                sampleLayout.RowSpacing = 10;

                mrow1.Height = mrow2.Height = mrow3.Height = mrow4.Height = mrow5.Height 
                    = mrow6.Height = mrow7.Height = mrow8.Height = 70;

                sampleLayout.Margin = new Thickness(150, 50, 150, 10);

                validationStack.Spacing = 10;
                cultureStack.Spacing = 10;
                ...
                optionLayout.Margin = new Thickness(140, 30, 140, 10);
            }
            else if (Device.RuntimePlatform == Device.Android)
            {
                ...
                {
                    hidePromptToggle.HeightRequest = 70;
                    lblToAccount.HeightRequest = 30;
                    lblDesc.HeightRequest = 30;
                    lblAmount.HeightRequest = 30;
                    lblEmail.HeightRequest = 30;
                    lblPhone.HeightRequest = 30;

                    lblToAccount.FontSize = 18;
                    lblDesc.FontSize = 18;
                    lblAmount.FontSize = 18;
                    lblEmail.FontSize = 18;
                    lblPhone.FontSize = 18;
                    ...
                    lblCutCopy.HeightRequest = 30;
                    lblCutCopy.FontSize = 18;
                    validationPicker.HeightRequest = 50;

                    lblCulture.HeightRequest = 30;
                    lblCulture.FontSize = 18;
                    localePicker.HeightRequest = 50;

                    lblHidePromt.HeightRequest = 30;
                    lblHidePromt.FontSize = 18;
                    hidePromptToggle.WidthRequest = 50;
                    hidePromptToggle.HeightRequest = 30;

                    lblPrompt.HeightRequest = 30;
                    lblPrompt.FontSize = 18;
                    promptPicker.WidthRequest = 50;
                    promptPicker.HeightRequest = 45;

                    maskEdit1.Padding = new Thickness(-3, 0, 0, 0);
                    maskEdit2.Padding = new Thickness(-3, 0, 0, 0);
                    maskEdit3.Padding = new Thickness(-3, 0, 0, 0);
                    maskEdit4.Padding = new Thickness(-3, 0, 0, 0);
                    maskEdit5.Padding = new Thickness(-3, 0, 0, 0);
                    ...
                    optionLayout.Margin = new Thickness(10, 20, 0, 50);
                    gridOption.Margin = new Thickness(0, 10, 0, 0);
                    gridOption.RowSpacing = 20;
        ...
        void Handle_Clicked(object sender, System.EventArgs e)
        {
                ...
                else 
                {
                    ...
                    sfAmount.Value = string.Empty;
                    sfEmail.Value = string.Empty;
                    sfPhone.Value = string.Empty;
                }
        }
