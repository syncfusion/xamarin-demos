...
namespace SampleBrowser.SfMaskedEdit.Droid
{
    [Activity(Label = "SampleBrowser SfMaskedEdit", MainLauncher = false, Icon = "@drawable/AppIcon", Theme = "@style/MainTheme", ConfigurationChanges = ConfigChanges.ScreenSize | ConfigChanges.Orientation)]
