...
namespace SampleBrowser.SfDataForm
{
    ...
    public class ContactFormBehaviors : Behavior<SampleView>
    {
        ...
        protected async override void OnAttachedTo(SampleView bindable)
        {
            ...
            this.myGrid.Children.Add(new Image() { Opacity = 1.0, HorizontalOptions = LayoutOptions.FillAndExpand, VerticalOptions = LayoutOptions.FillAndExpand, Source = ImagePathConverter.GetImageSource("SampleBrowser.SfDataForm.TapEditIllustration.png") }, 1, 1);
