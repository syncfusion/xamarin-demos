...
namespace SampleBrowser
{
    ...
    public class ContactInfo : INotifyPropertyChanged
    {
        ...
        [Display(Prompt = "First Name", GroupName = "Name", Order = 1)]
        ...
        [Display(Prompt = "Middle Name", GroupName = "Name", Order = 2)]
        ...
        /// </summary>
        [DisplayOptions(ShowLabel = false, ColumnSpan = 2)]
        [Display(Prompt = "Last Name", GroupName = "Name", Order = 3)]
        ...
        /// </summary>
        [Display(Prompt = "Address", Order = 8)]
        ...
        /// </summary>
        [DisplayOptions(ColumnSpan = 2)]
        [Display(Prompt = "Birth Date", Order = 11)]
        ...
        /// </summary>
        [DisplayOptions(ColumnSpan = 2)]
        [Display(Prompt = "Save To", ShortName = "Save To", Order = 13)]
        public Save SaveTo
        {
            get
            {
