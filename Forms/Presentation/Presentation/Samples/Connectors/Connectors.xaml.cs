    ...
    public partial class Connectors : SampleView
    {
        ...
        void OnButtonClicked(object sender, EventArgs e)
        {
            ...
            if (Device.RuntimePlatform == Device.UWP)
                Xamarin.Forms.DependencyService.Get<ISaveWindowsPhone>().Save("ConnectorsSample.pptx", "application/vnd.openxmlformats-officedocument.presentationml.presentation", stream);
            else
                Xamarin.Forms.DependencyService.Get<ISave>().Save("ConnectorsSample.pptx", "application/vnd.openxmlformats-officedocument.presentationml.presentation", stream);
        }
