...
namespace SampleBrowser.SfRadioButton.Droid
{
    [Activity(Label = "SampleBrowser SfRadioButton", MainLauncher = false, Icon = "@drawable/AppIcon", Theme = "@style/MainTheme", ConfigurationChanges = ConfigChanges.ScreenSize | ConfigChanges.Orientation)]
