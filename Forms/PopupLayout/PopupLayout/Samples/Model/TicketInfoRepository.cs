...
namespace SampleBrowser.SfPopupLayout
{
    ...
    public class TicketInfoRepository
    {
        ...
        private ObservableCollection<TicketBookingInfo> PopulateList(ObservableCollection<TicketBookingInfo> items)
        {
            ...
            {
                MovieImage = "Popup_Movie1".GetImageSource(),
                InfoImage = "Popup_Info".GetImageSource(),
            ...
            items.Add(new TicketBookingInfo
            {
                MovieImage = "Popup_Movie2".GetImageSource(),
                InfoImage = "Popup_Info".GetImageSource(),
            ...
            items.Add(new TicketBookingInfo
            {
                MovieImage = "Popup_Movie3".GetImageSource(),
                InfoImage = "Popup_Info".GetImageSource(),
            ...
            items.Add(new TicketBookingInfo
            {
                MovieImage = "Popup_Movie4".GetImageSource(),
                InfoImage = "Popup_Info".GetImageSource(),
            ...
            items.Add(new TicketBookingInfo
            {
                MovieImage = "Popup_Movie5".GetImageSource(),
                InfoImage = "Popup_Info".GetImageSource(),
            ...
            items.Add(new TicketBookingInfo
            {
                MovieImage = "Popup_Movie6".GetImageSource(),
                InfoImage = "Popup_Info".GetImageSource(),
            ...
            items.Add(new TicketBookingInfo
            {
                MovieImage = "Popup_Movie7".GetImageSource(),
                InfoImage = "Popup_Info".GetImageSource(),
            ...
            items.Add(new TicketBookingInfo
            {
                MovieImage = "Popup_Movie8".GetImageSource(),
                InfoImage = "Popup_Info".GetImageSource(),
            ...
            items.Add(new TicketBookingInfo
            {
                MovieImage = "Popup_Movie9".GetImageSource(),
                InfoImage = "Popup_Info".GetImageSource(),
            ...
            items.Add(new TicketBookingInfo
            {
                MovieImage = "Popup_Movie10".GetImageSource(),
                InfoImage = "Popup_Info".GetImageSource(),
