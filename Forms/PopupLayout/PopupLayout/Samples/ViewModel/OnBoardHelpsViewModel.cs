...
namespace SampleBrowser.SfPopupLayout
{
    ...
    public class OnBoardHelpsViewModel : INotifyPropertyChanged
    {
        ...
        {
            this.HandSymbolImage = "HandSymbol".GetImageSource();
            this.EditingIllustrationImage = "EditIllustration".GetImageSource();
            this.ResizingIllustrationImage = "ResizingIllustration".GetImageSource();
            this.SwipingIllustrationImage = "SwipeIllustration".GetImageSource();
            this.DragAndDropLayoutImage = "DragAndDropIllustration".GetImageSource();
        }
