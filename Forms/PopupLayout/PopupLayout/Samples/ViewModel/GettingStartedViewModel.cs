...
namespace SampleBrowser.SfPopupLayout
{
    ...
    public class GettingStartedViewModel : INotifyPropertyChanged
    {
        ...
        public GettingStartedViewModel()
        {
            ...
            this.OpenBlurDialog = new Command<SfPopupLayout>(this.DisplayBlurBackgroundDialog);
        ...
        /// <summary>
        /// Gets or sets the command for opening the blur background popup.
        /// </summary>
        public Command<SfPopupLayout> OpenBlurDialog { get; set; }
        ...
        {
            popupLayout.OverlayMode = OverlayMode.Transparent;
            popupLayout.Show();
        }
        ...
        /// <summary>
        /// Displays the blur background popup.
        /// </summary>
        /// <param name="popupLayout">Popup to be displayed.</param>
        private void DisplayBlurBackgroundDialog(SfPopupLayout popupLayout)
        {
