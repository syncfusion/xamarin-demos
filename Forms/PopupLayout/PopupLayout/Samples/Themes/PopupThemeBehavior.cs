...
namespace SampleBrowser.SfPopupLayout
{
    ...
    public class PopupThemeBehavior : Behavior<SampleView>
    {
        ...
        [SuppressMessage("StyleCop.CSharp.DocumentationRules", "SA1600:ElementsMustBeDocumented", Justification = "Reviewed. Suppression is OK here.Private field does not need documentation")]
        private SfButton alertWithTitle;
        [SuppressMessage("StyleCop.CSharp.DocumentationRules", "SA1600:ElementsMustBeDocumented", Justification = "Reviewed. Suppression is OK here.Private field does not need documentation")]
        ...
        private void AlertWithTitle_Clicked(object sender, EventArgs e)
        {
...
#if COMMONSB
            var parent = ((((sender as SfButton).Parent as StackLayout).Parent as ScrollView).Parent as Syncfusion.XForms.PopupLayout.SfPopupLayout).Parent;
            while (parent != null)
            {
            ...
            parent = null;
#else
            mergedDictionaries = (((((sender as SfButton).Parent as StackLayout).Parent as ScrollView).Parent as Syncfusion.XForms.PopupLayout.SfPopupLayout).Parent as SampleView).Resources.MergedDictionaries;
#endif
