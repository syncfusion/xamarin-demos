...
namespace SampleBrowser.SfPopupLayout
{
    ...
    public class TicketBookingViewModel : INotifyPropertyChanged
    {
        ...
        /// </summary>
        private Command<SfDataGrid> timingCommand;        
        ...
        /// </summary>
        private Command<SfPopupLayout> declineCommand;        
        ...
        /// </summary>
        private Command<string> openInfoCommand;
        ...
        public TicketBookingViewModel()
        {
            ...
            this.timingCommand = new Command<SfDataGrid>(this.OnTimingButtonClicked);
            ...
            this.declineCommand = new Command<SfPopupLayout>(this.OnDeclineButtonClicked);
            this.seatSelectionCommand = new Command<Label>(this.SelectSeat);
            this.openInfoCommand = new Command<string>(this.OpenInfoPopup);
        ...
        /// </summary>
        public Command<SfDataGrid> TimingCommand
        {
            get
            {
        ...
        /// </summary>
        public Command<SfPopupLayout> DeclineCommand
        {
            get
            {
        ...
        /// </summary>
        public Command<string> OpenInfoCommand
        {
            get
            {
        ...
        /// <summary>
        /// Gets or sets the source for the Ticket Image.
        /// </summary>
        public ImageSource TicketImage { get; set; }

        /// <summary>
        /// Gets or sets the source for the Parking Image.
        /// </summary>
        public ImageSource ParkingImage { get; set; }

        /// <summary>
        /// Gets or sets the source for the FoodCourt Image.
        /// </summary>
        public ImageSource FoodCourtImage { get; set; }
        ...
        private void OnTimingButtonClicked(SfDataGrid dataGridObject)
        {
            if (dataGridObject != null)
            {
                ((dataGridObject.Parent as ContentPage).Resources["termsAndConditionsDialog"] as SfPopupLayout).Show();
            }
        }
        ...
        private async void OnProceedButtonClicked(SfPopupLayout popupObject)
        {
            if (popupObject != null)
            {
                popupObject.Dismiss();
            ...
            ((popupObject.Parent as NavigationPage).CurrentPage.Resources["confirmationDialog"] as SfPopupLayout).Show();
        }
        ...
        /// </summary>
        /// <param name="popupObject">Popup's object in view</param>
        private async void OnAcceptButtonClicked(SfPopupLayout popupObject)
        {
            if (popupObject != null)
            {
                popupObject.Dismiss();
            ...
            await Task.Delay(200);
            ((popupObject.Parent as NavigationPage).CurrentPage.Resources["BookingDialog"] as SfPopupLayout).Show();
        }
        ...
        /// </summary>
        /// <param name="theatreName">The theatre name on which info icon is clicked.</param>
        private void OpenInfoPopup(string theatreName)
        {
            var infoPopup = (App.Current.MainPage as NavigationPage).CurrentPage.Resources["InformationDialog"] as SfPopupLayout;
            infoPopup.PopupView.HeaderTitle = theatreName;
            infoPopup.Show();
        }
        ...
        {
#if COMMONSB
                this.TicketImage = ImageSource.FromResource(
                "SampleBrowser.Images.Popup_MTicket.png",
                typeof(TicketBookingViewModel).GetTypeInfo().Assembly);
#else
            this.TicketImage = ImageSource.FromResource(
            "SampleBrowser.SfPopupLayout.Images.Popup_MTicket.png",
            typeof(TicketBookingViewModel).GetTypeInfo().Assembly);
#endif

#if COMMONSB
                this.ParkingImage = ImageSource.FromResource(
                "SampleBrowser.Images.Popup_Parking.png",
                typeof(TicketBookingViewModel).GetTypeInfo().Assembly);
#else
            this.ParkingImage = ImageSource.FromResource(
            "SampleBrowser.SfPopupLayout.Images.Popup_Parking.png",
            typeof(TicketBookingViewModel).GetTypeInfo().Assembly);
#endif

#if COMMONSB
                this.FoodCourtImage = ImageSource.FromResource(
                "SampleBrowser.Images.Popup_FoodCourt.png",
                typeof(TicketBookingViewModel).GetTypeInfo().Assembly);
#else
            this.FoodCourtImage = ImageSource.FromResource(
            "SampleBrowser.SfPopupLayout.Images.Popup_FoodCourt.png",
            typeof(TicketBookingViewModel).GetTypeInfo().Assembly);
#endif
        }
