...
namespace SampleBrowser.SfRotator.Droid
{
    [Activity(Label = "SampleBrowser.SfRotator", Icon = "@drawable/AppIcon", Theme = "@style/MainTheme", MainLauncher = false, ConfigurationChanges = ConfigChanges.ScreenSize | ConfigChanges.Orientation)]
