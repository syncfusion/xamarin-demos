...
namespace SampleBrowser.SfNavigationDrawer
{
	...
	public class MenuCollectionViewModel
	{
		...
		{
            ImagePathConverter.GetImageSource("SampleBrowser.SfNavigationDrawer.Available.png"),
            ImagePathConverter.GetImageSource("SampleBrowser.SfNavigationDrawer.Offline.png"),
            ImagePathConverter.GetImageSource("SampleBrowser.SfNavigationDrawer.Away.png"),
            ImagePathConverter.GetImageSource("SampleBrowser.SfNavigationDrawer.Busy.png"),
            ImagePathConverter.GetImageSource("SampleBrowser.SfNavigationDrawer.DND.png"),
            ImagePathConverter.GetImageSource("SampleBrowser.SfNavigationDrawer.Offline.png"),
            ImagePathConverter.GetImageSource("SampleBrowser.SfNavigationDrawer.Available.png"),
            ImagePathConverter.GetImageSource("SampleBrowser.SfNavigationDrawer.Available.png")
        };
