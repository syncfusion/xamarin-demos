...
namespace SampleBrowser.SfNavigationDrawer
{
	...
	public class MenuCollectionViewModel
	{
		...
		public MenuCollectionViewModel()
		{
            ...
            {
                this.menuCollection.Add(getItem("Inbox", "\xE71F"));
                this.menuCollection.Add(getItem("Starred", "\xE721"));
                this.menuCollection.Add(getItem("Sent mail", "\xE72B"));
                this.menuCollection.Add(getItem("Drafts", "\xE724"));
                this.menuCollection.Add(getItem("All mail", "\xE71F"));
                this.menuCollection.Add(getItem("Trash", "\xE71B"));
                this.menuCollection.Add(getItem("Spam", "\xE71C"));
                this.menuCollection.Add(getItem("Follow up", "\xE723"));
            }
        }
