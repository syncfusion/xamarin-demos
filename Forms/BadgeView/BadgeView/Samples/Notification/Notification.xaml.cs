    ...
    public partial class Notification : SampleView
    {
        ...
        public Notification()
        {
            ...
            switch (Device.RuntimePlatform)
            {
                ...
                case Device.WPF:
                    {
                        fontIconLabel2.VerticalOptions = LayoutOptions.End;
                        fontIconLabel2.HorizontalOptions = LayoutOptions.Center;
                        fontIconLabel4.VerticalOptions = LayoutOptions.End;
                        fontIconLabel4.HorizontalOptions = LayoutOptions.Center;
                    }
