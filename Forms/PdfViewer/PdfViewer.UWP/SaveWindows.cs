...
[assembly: Dependency(typeof(SampleBrowser.SfPdfViewer.UWP.BrowserURI))]
namespace SampleBrowser.SfPdfViewer.UWP
{
    ...
    public class BrowserURI : IDeviceOpenURI
    {
        ...
        {
            this.OpenURIAsync(selectedText);
        }

        private async void OpenURIAsync(string selectedText)
        {
            var uriBing = new Uri($"https://www.google.com/search?q={selectedText}");
