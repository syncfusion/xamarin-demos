...
namespace SampleBrowser.SfPdfViewer
{
    public class FontMappingHelper
    {
        ...
        internal static string Bookmark_Default  = "\uE703";

        internal static string Bookmark_Custom = "\uE702";

        internal static string Bookmark_Add = "\uE700";

        internal static string DeleteBookmark  = "\uE704";

        internal static string RenameBookmark  = "\uE705";
        ...
        public static string Squiggly = Device.RuntimePlatform == Device.Android ? "\uE704" : Device.RuntimePlatform == Device.iOS ? "\uE711" : "\uE703";
        ...
        public static string Cloud = Device.RuntimePlatform == Device.Android ? "\uE700" : "\uE701";
        ...
        public static string CustomBookmarkFont = 
            Device.RuntimePlatform == Device.Android ? 

            "Xamarin_Bookmark_Icon.ttf" :

            Device.RuntimePlatform == Device.iOS ?

            "Xamarin_Bookmark_Icon" :

            "/Assets/Fonts/Xamarin_Bookmark_Icon.ttf#Xamarin_Bookmark_Icon";
        ...
        public static string PolylineFont =
            Device.RuntimePlatform == Device.Android ? "Polyline_Font.ttf" :
            Device.RuntimePlatform == Device.iOS ? "xama" : "/Assets/Fonts/xama.ttf#xama";

        public static string PopupFont =
            Device.RuntimePlatform == Device.Android ? "Popup Font.ttf" :
            Device.RuntimePlatform == Device.iOS ? "font" : "/Assets/Fonts/Popup Font.ttf#font";
        ...
        public static string EditPopup = "\uE700";

        public static string EraserFont =
            Device.RuntimePlatform == Device.Android ? "Xamarin_Eraser.ttf" : 
            Device.RuntimePlatform == Device.iOS ? "Xamarin_Eraser" : "/Assets/Fonts/Xamarin_Eraser.ttf#Xamarin_Eraser";
