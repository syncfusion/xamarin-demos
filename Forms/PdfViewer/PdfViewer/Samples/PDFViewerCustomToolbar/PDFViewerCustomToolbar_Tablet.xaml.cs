...
namespace SampleBrowser.SfPdfViewer
{
    ...
    public partial class PDFViewerCustomToolbar_Tablet : SampleView
    {
        ...
        internal EditBookmarkPopup editBookmarkPopup;
        ...
        public PDFViewerCustomToolbar_Tablet()
        {
            ...
            editBookmarkPopup = new EditBookmarkPopup(this);
        ...
        private void PdfViewerControl_PageChanged(object sender, PageChangedEventArgs args)
        {
            ...
            foreach (var item in pdfViewer.CustomBookmarks)
            {
                ...
                {
                    bookmarkToolbar.AddBookmarkButton.IsEnabled = false;
                    break;
                }
                else
                {
                    bookmarkToolbar.AddBookmarkButton.IsEnabled = true;
                }
            }
        ...
        {
            Grid.SetRow(editBookmarkPopup, 0);
            Grid.SetColumn(editBookmarkPopup, 0);
            Grid.SetRowSpan(editBookmarkPopup, 2);
            mainGrid.Children.Add(editBookmarkPopup);
        }
        internal void PositionToastMessage()
        {
            Grid.SetRow(bookmarkToolbar.toastMessageFrame, 0);
            Grid.SetRowSpan(bookmarkToolbar.toastMessageFrame, 2);
            Grid.SetColumn(bookmarkToolbar.toastMessageFrame, 0);
            mainGrid.Children.Add(bookmarkToolbar.toastMessageFrame);
        }
        ...
        private void AnnotationButtonClicked(object sender, EventArgs args)
        {
            ...
            editBookmarkPopup.IsVisible = false;
        ...
        private void OpacitySlider_ValueChanged(object sender, ValueChangedEventArgs e)
        {
            if (canSetValueToSource)
            {
                if (selectedInkAnnotation != null)
                    ...
                    pdfViewerControl.AnnotationSettings.Polygon.Settings.Opacity = (float)(Math.Round(e.NewValue, 0) / 100);
                else if (pdfViewerControl.AnnotationMode == AnnotationMode.Polyline)
                    pdfViewerControl.AnnotationSettings.Polyline.Settings.Opacity = (float)(Math.Round(e.NewValue, 0) / 100);
        ...
        private void ThicknessButton_Clicked(object sender, EventArgs e)
        {
            if (selectedInkAnnotation != null && selectedInkAnnotation.Settings.Thickness <= 10)
                ...
                slider.Value = pdfViewerControl.AnnotationSettings.Polygon.Settings.Thickness;
            else if (pdfViewerControl.AnnotationMode == AnnotationMode.Polyline)
                slider.Value = pdfViewerControl.AnnotationSettings.Polyline.Settings.Thickness;
        }
        ...
        private void PdfViewerControl_ShapeAnnotationSelected(object sender, ShapeAnnotationSelectedEventArgs args)
        {
            ...
            {
                if (selectedShapeAnnotation.Settings.BorderEffect == BorderEffect.Solid)
                {
        ...
        {
            bookmarkToolbar.UpdateBookmarkContent();
            bookmarkToolbar.UpdateCustomBookmarkView();
