...
namespace SampleBrowser.SfPdfViewer
{
    ...
    public partial class PDFViewerCustomToolbar_Desktop : SampleView
    {
        ...
        internal BookMarkPane bookMarkPane;
        internal PdfLoadedDocument bookmarkLoadedDocument;
        string currentDocument = "F# Succinctly";
        bool isDocumentLoaded = false;
        internal EditBookmarkPopup BookmarkPopup { get; set; }
        internal IList<ContentBookmark> ListViewItemsSource = new ObservableCollection<ContentBookmark>();
        ...
        public PDFViewerCustomToolbar_Desktop()
        {
            ...
            pdfViewerControl.PopupAnnotationDeselected += PdfViewerControl_PopupAnnotationDeselected;
            pdfViewerControl.PopupAnnotationViewAppearing += PdfViewerControl_PopupAnnotationViewAppearing;
            pdfViewerControl.PopupAnnotationViewDisappeared += PdfViewerControl_PopupAnnotationViewDisappeared;
            pdfViewerControl.PageChanged += PdfViewerControl_PageChanged;
            TextSelectionMenuItem item = new TextSelectionMenuItem();
            item.Text = "Search in browser";
            item.Id = "find";
            pdfViewerControl.TextSelectionSettings.MenuOptions.Items.Add(item);
            pdfViewerControl.TextSelectionCompleted += PdfViewerControl_TextSelectionCompleted;
            pdfViewerControl.TextSelectionSettings.MenuOptions.TextSelectionMenuItemClicked += MenuOptions_TextSelectionMenuItemClicked;
            ...
            (BindingContext as PdfViewerViewModel).SquigglyColor = pdfViewerControl.AnnotationSettings.TextMarkup.Squiggly.Color;
            ...
            (BindingContext as PdfViewerViewModel).PolygonStrokeColor = pdfViewerControl.AnnotationSettings.Polygon.Settings.StrokeColor;
            (BindingContext as PdfViewerViewModel).CloudStrokeColor = pdfViewerControl.AnnotationSettings.Polygon.Settings.StrokeColor;
            (BindingContext as PdfViewerViewModel).PolylineStrokeColor = pdfViewerControl.AnnotationSettings.Polyline.Settings.StrokeColor;
            ...
            (BindingContext as PdfViewerViewModel).PopupColor = pdfViewerControl.AnnotationSettings.Popup.Color;
            (BindingContext as PdfViewerViewModel).PopupIcon = pdfViewerControl.AnnotationSettings.Popup.Icon;
            ...
            eraserThicknessSlider.ShowValueLabel = false;
            eraserThicknessSlider.Minimum = 5;
            eraserThicknessSlider.Maximum = 150;
            eraserThicknessSlider.Value = 40;
            eraserThicknessSlider.KnobColor = (Device.RuntimePlatform == Device.iOS) ? Color.White : Color.Blue;
            eraserThicknessSlider.TrackSelectionColor = Color.Blue;
            eraserThicknessSlider.TrackColor = Color.Gray;
            eraserThicknessSlider.TickFrequency = 10;
            eraserThicknessSlider.StepFrequency = 1;
            eraserThicknessSlider.ShowRange = false;
            eraserThicknessSlider.Orientation = Syncfusion.SfRangeSlider.XForms.Orientation.Horizontal;
            eraserThicknessSlider.TickPlacement = TickPlacement.Inline;
            eraserThicknessSlider.ToolTipPlacement = ToolTipPlacement.None;
            eraserThicknessSlider.Value = pdfViewerControl.AnnotationSettings.InkEraser.Thickness;
            eraserThicknessSlider.ValueChanging += EraserThicknessSlider_ValueChanging;
            eraserThicknessSliderValue.Text = pdfViewerControl.AnnotationSettings.InkEraser.Thickness.ToString();
            ...
            BookmarkPopup = new EditBookmarkPopup(this);
        ...
        private void PdfViewerControl_PageChanged(object sender, PageChangedEventArgs args)
        {
            ...
            foreach (var item in pdfViewer.CustomBookmarks)
            {
                if (item.PageNumber == args.NewPageNumber)
                {
                    bookMarkPane.AddBookmarkButton.InputTransparent = true;
                    bookMarkPane.AddBookmarkButton.BackgroundColor = Color.FromHex("#7BB9F2");
                    bookMarkPane.AddBookmarkLabel.Opacity = 0.7;
                    break;
                }
                else
                {
                    bookMarkPane.AddBookmarkButton.InputTransparent = false;
                    bookMarkPane.AddBookmarkButton.BackgroundColor = Color.FromHex("#007CEE");
                    bookMarkPane.AddBookmarkLabel.Opacity = 1;
                }
            }
           
        }

        private void PdfViewerControl_PopupAnnotationDeselected(object sender, EventArgs e)
        {
            isAnnotationEditMode = false;
            (BindingContext as PdfViewerViewModel).IsEditPopupAnnotationBarVisible = false;
            canSetValueToSource = false;
            selectedPopupAnnotation = null;
        }

        private void PdfViewerControl_PopupAnnotationSelected(object sender, EventArgs e)
        {
            selectedPopupAnnotation = sender as PopupAnnotation;
            isAnnotationEditMode = true;
            (BindingContext as PdfViewerViewModel).PopupDeleteColor = new Color(selectedPopupAnnotation.Settings.Color.R, selectedPopupAnnotation.Settings.Color.G, selectedPopupAnnotation.Settings.Color.B);
            (BindingContext as PdfViewerViewModel).EditPopupIcon = selectedPopupAnnotation.Settings.Icon;
            opacitySlider.Value = selectedPopupAnnotation.Settings.Opacity * 100;
            (BindingContext as PdfViewerViewModel).IsEditPopupAnnotationBarVisible = true;
            (BindingContext as PdfViewerViewModel).IsMainAnnotationBarVisible = false;
            canSetValueToSource = true;
        }

        private void PdfViewerControl_PopupAnnotationViewDisappeared(object sender, PopupAnnotationViewDisappearedEventArgs e)
        {
            ...
            (BindingContext as PdfViewerViewModel).IsPopupIconSelectorBarVisible = false;
            if ((BindingContext as PdfViewerViewModel).IsPopupBarVisible)
                (BindingContext as PdfViewerViewModel).IsPopupBarVisible = false;
            if (selectedPopupAnnotation != null && !(BindingContext as PdfViewerViewModel).IsEditPopupAnnotationBarVisible)
            {
                (BindingContext as PdfViewerViewModel).IsEditPopupAnnotationBarVisible = true;
                (BindingContext as PdfViewerViewModel).AnnotationGridHeightRequest = 50;
            }
            else
                (BindingContext as PdfViewerViewModel).AnnotationGridHeightRequest = 0;
        }

        private void PdfViewerControl_PopupAnnotationViewAppearing(object sender, EventArgs e)
        {
            (BindingContext as PdfViewerViewModel).IsOpacityBarVisible = false;
            (BindingContext as PdfViewerViewModel).IsShapeColorBarVisible = false;
            (BindingContext as PdfViewerViewModel).IsPopupIconSelectorBarVisible = false;
            if ((BindingContext as PdfViewerViewModel).IsPopupBarVisible)
                (BindingContext as PdfViewerViewModel).IsPopupBarVisible = false;
            if ((BindingContext as PdfViewerViewModel).IsEditPopupAnnotationBarVisible)
                (BindingContext as PdfViewerViewModel).IsEditPopupAnnotationBarVisible = false;
        }

        private void MenuOptions_TextSelectionMenuItemClicked(object sender, EventArgs e)
        {
            if ((sender as TextSelectionMenuItem).Id == "find")
            {
                DependencyService.Get<IDeviceOpenURI>().OpenURI(this.selectedText);
            }
        }
        ...
        private void EditPopupTextButton_Clicked(object sender, EventArgs e)
        {
            pdfViewerControl.EditPopupAnnotationText();
        }
        ...
        private void EraserThicknessSlider_ValueChanging(object sender, ValueEventArgs e)
        {
            if (canSetValueToSource)
            {
                if (pdfViewerControl.AnnotationMode == AnnotationMode.InkEraser)
                    pdfViewerControl.AnnotationSettings.InkEraser.Thickness = (int)(e.Value);
            }

            eraserThicknessSliderValue.Text = ((Int32)e.Value).ToString();
            canSetValueToSource = true;
        }
        ...
        private void PdfViewerControl_ShapeAnnotationDeselected(object sender, ShapeAnnotationDeselectedEventArgs args)
        {
            ...
            else if ((BindingContext as PdfViewerViewModel).IsEditPolygonAnnotationBarVisible)
                (BindingContext as PdfViewerViewModel).IsEditPolygonAnnotationBarVisible = false;
            else if ((BindingContext as PdfViewerViewModel).IsEditCloudAnnotationBarVisible)
                (BindingContext as PdfViewerViewModel).IsEditCloudAnnotationBarVisible = false;
            else if ((BindingContext as PdfViewerViewModel).IsEditPolylineAnnotationBarVisible)
                (BindingContext as PdfViewerViewModel).IsEditPolylineAnnotationBarVisible = false;
        ...
        {
            bookMarkPane.UpdateBookmarkContent();
            bookMarkPane.UpdateCustomBookmarkView();

            if (pdfViewer.CustomBookmarks.Count != 0)
            {
                foreach (var item in pdfViewer.CustomBookmarks)
                {
                    if (item.PageNumber == pdfViewer.PageNumber)
                    {
                        bookMarkPane.AddBookmarkButton.InputTransparent = true;
                        bookMarkPane.AddBookmarkButton.BackgroundColor = Color.FromHex("#7BB9F2");
                        bookMarkPane.AddBookmarkLabel.Opacity = 0.7;
        ...
        private void ThicknessButton_Clicked(object sender, EventArgs e)
        {
            ...
            else if (pdfViewerControl.AnnotationMode == AnnotationMode.Polygon)
                thicknessSlider.Value = pdfViewerControl.AnnotationSettings.Polygon.Settings.Thickness;
            else if (pdfViewerControl.AnnotationMode == AnnotationMode.Polyline)
                thicknessSlider.Value = pdfViewerControl.AnnotationSettings.Polyline.Settings.Thickness;
        }
        ...
        private void ThicknessSlider_ValueChanged(object sender, ValueChangedEventArgs e)
        {
              if (canSetValueToSource)
            {
                if (selectedInkAnnotation != null)
                    ...
                    pdfViewerControl.AnnotationSettings.Polygon.Settings.Thickness = (int)Math.Round(e.NewValue, 0);
                else if (pdfViewerControl.AnnotationMode == AnnotationMode.Polyline)
                    pdfViewerControl.AnnotationSettings.Polyline.Settings.Thickness = (int)Math.Round(e.NewValue, 0);
            }
        ...
        private void OpacitySlider_ValueChanged(object sender, ValueChangedEventArgs e)
        {
            if (canSetValueToSource)
            {
                if (selectedInkAnnotation != null)
                ...
                else if (selectedPopupAnnotation != null)
                    selectedPopupAnnotation.Settings.Opacity = (float)(e.NewValue / 100);
                else if(pdfViewerControl.AnnotationMode == AnnotationMode.Ink)
                    ...
                    pdfViewerControl.AnnotationSettings.Polygon.Settings.Opacity = (float)(e.NewValue / 100);
                else if (pdfViewerControl.AnnotationMode == AnnotationMode.Polyline)
                    pdfViewerControl.AnnotationSettings.Polyline.Settings.Opacity = (float)(e.NewValue / 100);
                else if (pdfViewerControl.AnnotationMode == AnnotationMode.Popup)
                    pdfViewerControl.AnnotationSettings.Popup.Opacity = (float)(e.NewValue / 100);
            }
        ...
        private void PopupDeleteButton_Clicked(object sender, EventArgs e)
        {
            if (selectedPopupAnnotation != null)
            {
                pdfViewerControl.RemoveAnnotation(selectedPopupAnnotation);
                selectedPopupAnnotation = null;
                isAnnotationEditMode = false;
            }
        }
        ...
        internal void ToggleBookmarkPopup()
        {
            Grid.SetRow(BookmarkPopup, 0);
            Grid.SetColumn(BookmarkPopup, 0);
            Grid.SetRowSpan(BookmarkPopup,2);
            mainGrid.Children.Add(BookmarkPopup);
        }
        internal void PositionToastMessage()
        {
            Grid.SetRow(bookMarkPane.toastMessageFrame, 0);
            Grid.SetRowSpan(bookMarkPane.toastMessageFrame, 2);
            Grid.SetColumn(bookMarkPane.toastMessageFrame, 0);
            mainGrid.Children.Add(bookMarkPane.toastMessageFrame);
        }
                ...
                case "Cyan":
                    {
                        if (!isAnnotationEditMode)
                        {
                            ...
                            if (pdfViewerControl.AnnotationMode == AnnotationMode.Squiggly)
                                pdfViewerControl.AnnotationSettings.TextMarkup.Squiggly.Color = Color.FromHex("#00FFFF");
                            ...
                            if (pdfViewerControl.AnnotationMode == AnnotationMode.Polygon)
                                pdfViewerControl.AnnotationSettings.Polygon.Settings.StrokeColor = Color.FromHex("#00FFFF");
                            if (pdfViewerControl.AnnotationMode == AnnotationMode.Polyline)
                                pdfViewerControl.AnnotationSettings.Polyline.Settings.StrokeColor = Color.FromHex("#00FFFF");
                            if(pdfViewerControl.AnnotationMode == AnnotationMode.Popup)
                                pdfViewerControl.AnnotationSettings.Popup.Color = Color.FromHex("#00FFFF");
                        ...
                        else
                        {
                            ...
                            if(selectedPopupAnnotation != null)
                                selectedPopupAnnotation.Settings.Color = Color.FromHex("#00FFFF");
                        }
                    }
                    break;
                ...
                case "Green":
                    {
                        if (!isAnnotationEditMode)
                        {
                            ...
                            if (pdfViewerControl.AnnotationMode == AnnotationMode.Squiggly)
                                pdfViewerControl.AnnotationSettings.TextMarkup.Squiggly.Color = Color.Green;
                            if (pdfViewerControl.AnnotationMode == AnnotationMode.Ink)
                            ...
                            if (pdfViewerControl.AnnotationMode == AnnotationMode.Polygon)
                                pdfViewerControl.AnnotationSettings.Polygon.Settings.StrokeColor = Color.Green;
                            if (pdfViewerControl.AnnotationMode == AnnotationMode.Polyline)
                                pdfViewerControl.AnnotationSettings.Polyline.Settings.StrokeColor = Color.Green;
                            if (pdfViewerControl.AnnotationMode == AnnotationMode.Popup)
                                pdfViewerControl.AnnotationSettings.Popup.Color = Color.Green;
                        ...
                        else
                        {
                            ...
                            if (selectedPopupAnnotation != null)
                                selectedPopupAnnotation.Settings.Color = Color.Green;
                        }
                    }
                    break;
                ...
                case "Yellow":
                    {
                        if (!isAnnotationEditMode)
                        {
                            ...
                            if (pdfViewerControl.AnnotationMode == AnnotationMode.Squiggly)
                                pdfViewerControl.AnnotationSettings.TextMarkup.Squiggly.Color = Color.Yellow;
                            if (pdfViewerControl.AnnotationMode == AnnotationMode.Ink)
                            ...
                            if (pdfViewerControl.AnnotationMode == AnnotationMode.Polygon)
                                pdfViewerControl.AnnotationSettings.Polygon.Settings.StrokeColor = Color.Yellow;
                            if (pdfViewerControl.AnnotationMode == AnnotationMode.Polyline)
                                pdfViewerControl.AnnotationSettings.Polyline.Settings.StrokeColor = Color.Yellow;
                            if (pdfViewerControl.AnnotationMode == AnnotationMode.Popup)
                                pdfViewerControl.AnnotationSettings.Popup.Color = Color.Yellow;
                        ...
                        else
                        {
                            ...
                            if (selectedPopupAnnotation != null)
                                selectedPopupAnnotation.Settings.Color = Color.Yellow;
                        }
                    }
                    break;
                ...
                case "Magenta":
                    {
                        if (!isAnnotationEditMode)
                        {
                            ...
                            if (pdfViewerControl.AnnotationMode == AnnotationMode.Squiggly)
                                pdfViewerControl.AnnotationSettings.TextMarkup.Squiggly.Color = Color.FromHex("#FF00FF");
                            if (pdfViewerControl.AnnotationMode == AnnotationMode.Ink)
                            ...
                            if (pdfViewerControl.AnnotationMode == AnnotationMode.Polygon)
                                pdfViewerControl.AnnotationSettings.Polygon.Settings.StrokeColor = Color.FromHex("#FF00FF"); 
                            if (pdfViewerControl.AnnotationMode == AnnotationMode.Polyline)
                                pdfViewerControl.AnnotationSettings.Polyline.Settings.StrokeColor = Color.FromHex("#FF00FF");
                            if (pdfViewerControl.AnnotationMode == AnnotationMode.Popup)
                                pdfViewerControl.AnnotationSettings.Popup.Color = Color.FromHex("#FF00FF");
                        ...
                        else
                        {
                            ...
                            if (selectedPopupAnnotation != null)
                                selectedPopupAnnotation.Settings.Color = Color.FromHex("FF00FF");
                        }
                    }
                    break;
                ...
                case "Black":
                    {
                        if (!isAnnotationEditMode)
                        {
                            ...
                            if (pdfViewerControl.AnnotationMode == AnnotationMode.Squiggly)
                                pdfViewerControl.AnnotationSettings.TextMarkup.Squiggly.Color = Color.Black;
                            if (pdfViewerControl.AnnotationMode == AnnotationMode.Ink)
                            ...
                            if (pdfViewerControl.AnnotationMode == AnnotationMode.Polygon)
                                pdfViewerControl.AnnotationSettings.Polygon.Settings.StrokeColor = Color.Black;
                            if (pdfViewerControl.AnnotationMode == AnnotationMode.Polyline)
                                pdfViewerControl.AnnotationSettings.Polyline.Settings.StrokeColor = Color.Black;
                            if (pdfViewerControl.AnnotationMode == AnnotationMode.Popup)
                                pdfViewerControl.AnnotationSettings.Popup.Color = Color.Black;
                        ...
                        else
                        {
                            ...
                            if (selectedPopupAnnotation != null)
                                selectedPopupAnnotation.Settings.Color = Color.Black;
                        }
                    }
                    break;
                ...
                case "White":
                    {
                        if (!isAnnotationEditMode)
                        {
                            ...
                            if (pdfViewerControl.AnnotationMode == AnnotationMode.Squiggly)
                                pdfViewerControl.AnnotationSettings.TextMarkup.Squiggly.Color = Color.White;
                            if (pdfViewerControl.AnnotationMode == AnnotationMode.Ink)
                            ...
                            if (pdfViewerControl.AnnotationMode == AnnotationMode.Polygon)
                                pdfViewerControl.AnnotationSettings.Polygon.Settings.StrokeColor = Color.White;
                            if (pdfViewerControl.AnnotationMode == AnnotationMode.Polyline)
                                pdfViewerControl.AnnotationSettings.Polyline.Settings.StrokeColor = Color.White;
                            if (pdfViewerControl.AnnotationMode == AnnotationMode.Popup)
                                pdfViewerControl.AnnotationSettings.Popup.Color = Color.White;
                        ...
                        else
                        {
                            ...
                            if (selectedPopupAnnotation != null)
                                selectedPopupAnnotation.Settings.Color = Color.White;
                        }
                    }
                    break;
            }
        ...
        private void PolygonBackButton_Clicked(object sender, EventArgs e)
        {
            pdfViewerControl.AnnotationMode = AnnotationMode.None;
            pdfViewerControl.SelectionMode = Syncfusion.SfPdfViewer.XForms.SelectionMode.None;
        }
        private void CloudBackButton_Clicked(object sender, EventArgs e)
        {
            pdfViewerControl.AnnotationMode = AnnotationMode.None;
            pdfViewerControl.SelectionMode = Syncfusion.SfPdfViewer.XForms.SelectionMode.None;
        }
        private void PolylineBackButton_Clicked(object sender, EventArgs e)
        {
            pdfViewerControl.AnnotationMode = AnnotationMode.None;
            pdfViewerControl.SelectionMode = Syncfusion.SfPdfViewer.XForms.SelectionMode.None;
        }
        ...
        private void ShapeAnnotationColorButton_Clicked(object sender, EventArgs e)
        {
            ...
            if (selectedShapeAnnotation != null)
                ...
                (BindingContext as PdfViewerViewModel).OpacityButtonColor = pdfViewerControl.AnnotationSettings.Polygon.Settings.StrokeColor;
            else if (pdfViewerControl.AnnotationMode == AnnotationMode.Polyline)
                (BindingContext as PdfViewerViewModel).OpacityButtonColor = pdfViewerControl.AnnotationSettings.Polyline.Settings.StrokeColor;
        }
        ...
        private void PdfViewerControl_ShapeAnnotationSelected(object sender, ShapeAnnotationSelectedEventArgs args)
        {
            ...
            else if (args.AnnotationType == AnnotationMode.Polygon)
            {
                if ((sender as ShapeAnnotation).Settings.BorderEffect == BorderEffect.Solid)
                {
                    (BindingContext as PdfViewerViewModel).PolygonDeleteColor = new Color(selectedShapeAnnotation.Settings.StrokeColor.R, selectedShapeAnnotation.Settings.StrokeColor.G, selectedShapeAnnotation.Settings.StrokeColor.B);
                    (BindingContext as PdfViewerViewModel).IsEditPolygonAnnotationBarVisible = true;
                }
                else
                {
                    (BindingContext as PdfViewerViewModel).CloudDeleteColor = new Color(selectedShapeAnnotation.Settings.StrokeColor.R, selectedShapeAnnotation.Settings.StrokeColor.G, selectedShapeAnnotation.Settings.StrokeColor.B);
                    (BindingContext as PdfViewerViewModel).IsEditCloudAnnotationBarVisible = true;
                }
            }
            else if (args.AnnotationType == AnnotationMode.Polyline)
            {
                (BindingContext as PdfViewerViewModel).PolylineDeleteColor = new Color(selectedShapeAnnotation.Settings.StrokeColor.R, selectedShapeAnnotation.Settings.StrokeColor.G, selectedShapeAnnotation.Settings.StrokeColor.B);
                (BindingContext as PdfViewerViewModel).IsEditPolylineAnnotationBarVisible = true;
            }
        ...
        private void OpacityButton_Clicked(object sender, EventArgs e)
        {
            if (selectedInkAnnotation != null)
                ...
                opacitySlider.Value = pdfViewerControl.AnnotationSettings.Polygon.Settings.Opacity * 100;
            else if (pdfViewerControl.AnnotationMode == AnnotationMode.Polyline)
                opacitySlider.Value = pdfViewerControl.AnnotationSettings.Polyline.Settings.Opacity * 100;
            else if (pdfViewerControl.AnnotationMode == AnnotationMode.Popup)
                opacitySlider.Value = pdfViewerControl.AnnotationSettings.Popup.Opacity * 100;
        }
        ...
        private void polygonButton_Clicked(object sender, EventArgs e)
        {
            pdfViewerControl.AnnotationSettings.Polygon.Settings.BorderEffect = BorderEffect.Solid;
        }

        private void cloudButton_Clicked(object sender, EventArgs e)
        {
            pdfViewerControl.AnnotationSettings.Polygon.Settings.BorderEffect = BorderEffect.Cloudy;
        }

        private void Popup_Clicked(object sender, EventArgs e)
        {
            pdfViewerControl.AnnotationMode = AnnotationMode.Popup;
        }

        private void PopupBackButton_Clicked(object sender, EventArgs e)
        {
            pdfViewerControl.AnnotationMode = AnnotationMode.None;
            pdfViewerControl.SelectionMode = Syncfusion.SfPdfViewer.XForms.SelectionMode.None;
        }

        private void InkEraser_Clicked(object sender, EventArgs e)
        {
        ...
        private void IconButton_Clicked(object sender, EventArgs e)
        {
            switch ((sender as Button).CommandParameter.ToString())
            {
                case "Comment":
                    {
                        if (!isAnnotationEditMode)
                            pdfViewerControl.AnnotationSettings.Popup.Icon = PopupIcon.Comment;
                        else if (selectedPopupAnnotation != null)
                            selectedPopupAnnotation.Settings.Icon = PopupIcon.Comment;
                    }
                    break;
                case "Note":
                    {
                        if (!isAnnotationEditMode)
                            pdfViewerControl.AnnotationSettings.Popup.Icon = PopupIcon.Note;
                        else if (selectedPopupAnnotation != null)
                            selectedPopupAnnotation.Settings.Icon = PopupIcon.Note;
                    }
                    break;
                case "Key":
                    {
                        if (!isAnnotationEditMode)
                            pdfViewerControl.AnnotationSettings.Popup.Icon = PopupIcon.Key;
                        else if (selectedPopupAnnotation != null)
                ...
                case "Help":
                    {
                        if (!isAnnotationEditMode)
                            pdfViewerControl.AnnotationSettings.Popup.Icon = PopupIcon.Help;
                        else if (selectedPopupAnnotation != null)
                            selectedPopupAnnotation.Settings.Icon = PopupIcon.Help;
                    }
                    break;
                case "Insert":
                    {
                        if (!isAnnotationEditMode)
                            pdfViewerControl.AnnotationSettings.Popup.Icon = PopupIcon.Insert;
                        else if (selectedPopupAnnotation != null)
                            selectedPopupAnnotation.Settings.Icon = PopupIcon.Insert;
                    }
                    break;
                case "Paragraph":
                    {
                        if (!isAnnotationEditMode)
                            pdfViewerControl.AnnotationSettings.Popup.Icon = PopupIcon.Paragraph;
                        else if (selectedPopupAnnotation != null)
                            selectedPopupAnnotation.Settings.Icon = PopupIcon.Paragraph;
                    }
                    break;
                case "NewParagraph":
                    {
                        if (!isAnnotationEditMode)
                            pdfViewerControl.AnnotationSettings.Popup.Icon = PopupIcon.NewParagraph;
                        else if (selectedPopupAnnotation != null)
                            selectedPopupAnnotation.Settings.Icon = PopupIcon.NewParagraph;
                    }
                    break;
            }
        }
