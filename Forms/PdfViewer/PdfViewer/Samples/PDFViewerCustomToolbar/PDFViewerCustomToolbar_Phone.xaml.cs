...
namespace SampleBrowser.SfPdfViewer
{
    ...
    public partial class PDFViewerCustomToolbar_Phone : SampleView
    {
        ...
        internal EditBookmarkPopup editBookmarkPopup { get; set; }
        ...
        public PDFViewerCustomToolbar_Phone()
        {
            ...
            eraserThicknessSlider.Value = 12;
            ...
            transparentBox_Left.FadeTo(0);
            transparentBox_Left.InputTransparent = true;
            transparentBox_Right.FadeTo(0.8);
            transparentBox_Right.InputTransparent = false;
        }
        ...
        private void AnnotationBarScrollView_Scrolled(object sender, ScrolledEventArgs e)
        {
            if (sender is ScrollView scrollView)
            {
                double scrollingSpace = scrollView.ContentSize.Width - scrollView.Width;
                if (scrollingSpace - 2 > e.ScrollX)
                {
                    transparentBox_Right.FadeTo(0.8);
                    transparentBox_Right.InputTransparent = false;
                }
                ...
                {
                    transparentBox_Right.FadeTo(0);
                    transparentBox_Right.InputTransparent = true;
                }
                if (e.ScrollX > 2)
                {
                    transparentBox_Left.FadeTo(0.8);
                    transparentBox_Left.InputTransparent = false;
                }
                else
                {
                    transparentBox_Left.FadeTo(0);
