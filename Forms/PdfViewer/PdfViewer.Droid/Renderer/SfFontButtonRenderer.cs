    ...
    public class SfFontButtonRenderer : Xamarin.Forms.Platform.Android.ButtonRenderer
    {
        ...
        protected override void OnElementChanged(ElementChangedEventArgs<Xamarin.Forms.Button> e)
        {
            ...
            if ((Element as SfFontButton).ButtonName == "viewModeButton")
                Control.TextSize = 22;
            else if ((Element as SfFontButton).ButtonName == "popupButton")
                Control.TextSize = 28;
            else if ((Element as SfFontButton).ButtonName == "renameBookmarkButton")
                Control.TextSize = 16;
            else if ((Element as SfFontButton).ButtonName == "deleteBookmarkButton")
                Control.TextSize = 16;
            else if ((Element as SfFontButton).ButtonName == "customHeader")
                Control.TextSize = 20;
            else if ((Element as SfFontButton).ButtonName == "defaultHeader")
                Control.TextSize = 25;
        }
    }
}