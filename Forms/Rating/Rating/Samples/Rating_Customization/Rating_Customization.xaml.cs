...
namespace SampleBrowser.SfRating
{
	public partial class Rating_Customization : SampleView
	{
		...
		public Rating_Customization()
		{
			...
			customItems.Add(new SfRatingItem() { SelectedView = new CustomRatingView("UnhappySelected.png", "20%", "Unhappy", this), UnSelectedView = new CustomRatingView("UnhappyUnselected.png", "20%", "Unhappy", this) });
