...
namespace SampleBrowser.SfImageEditor
{
    ...
    public partial class Customization : SampleView
    {
        ...
        public Customization()
        {
            ...
            #if COMMONSB
            imageEditor.Source = ImageSource.FromResource("SampleBrowser.Icons.Customize.jpg", assembly);
            #else
            imageEditor.Source = ImageSource.FromResource("SampleBrowser.SfImageEditor.Icons.Customize.jpg",assembly);
            #endif
            imageEditor.ToolbarSettings = new ToolbarSettings() { IsVisible = false };
            imageEditor.ItemSelected += ImageEditor_ItemSelected;
            if (Device.RuntimePlatform != Device.Android && Device.RuntimePlatform != Device.iOS)
            {
                resetButton.Image = "Assets/reset_customization.png";
                redoButton.Image = "Assets/redo_customization.png";
                undoButton.Image = "Assets/undo_customization.png";
                rectButton.Image = "Assets/rect_customization.png";
                textButton.Image = "Assets/text_customization.png";
                penButton.Image = "Assets/pen_customization.png";
                shareButton.Image = "Assets/share_customization.png";
