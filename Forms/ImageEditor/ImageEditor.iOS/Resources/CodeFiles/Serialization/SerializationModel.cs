...
namespace SampleBrowser.SfImageEditor
{
    public class SerializationViewModel : INotifyPropertyChanged
    {
        ...
        public SerializationViewModel()
        {
            ...
            {
#if COMMONSB
                new SerializationModel { Location = "SampleBrowser.Icons.CreateNew.png", Strm = null, SelectionImage = ImageSource.FromResource("SampleBrowser.Icons.NotSelected.png", assembly), ImageName = "CreateNew", HorizontalOption = LayoutOptions.Center, VerticalOption = LayoutOptions.Center, Visibility = "false", CreateNewvisibility = "true", Height = 50, BackGround = Color.FromHex("#065DC7"), SelectedImageVisibility = "false" },
                new SerializationModel { Location = "SampleBrowser.Icons.Chart.jpg", Strm = null, SelectionImage = ImageSource.FromResource("SampleBrowser.Icons.NotSelected.png", assembly), Imagestream = "SampleBrowser.Icons.Chart.txt", ImageName = "Chart", HorizontalOption = LayoutOptions.FillAndExpand, VerticalOption = LayoutOptions.FillAndExpand, Visibility = "true", Height = 50, BackGround = Color.FromHex("#D3D3D3"), CreateNewvisibility = "false", SelectedImageVisibility = "false", SelectedItemThickness = new Thickness(0, 0, 0, 0) },
                new SerializationModel { Location = "SampleBrowser.Icons.Venn.jpg", Strm = null, SelectionImage = ImageSource.FromResource("SampleBrowser.Icons.NotSelected.png", assembly), Imagestream = "SampleBrowser.Icons.Venn.txt", ImageName = "Venn Diagram", HorizontalOption = LayoutOptions.FillAndExpand, VerticalOption = LayoutOptions.FillAndExpand, Visibility = "true", Height = 50, BackGround = Color.FromHex("#D3D3D3"), CreateNewvisibility = "false", SelectedImageVisibility = "false", SelectedItemThickness = new Thickness(0, 0, 0, 0) },
                new SerializationModel { Location = "SampleBrowser.Icons.Freehand.jpg", Strm = null, SelectionImage = ImageSource.FromResource("SampleBrowser.Icons.NotSelected.png", assembly), Imagestream = "SampleBrowser.Icons.FreeHand.txt", ImageName = "Freehand", HorizontalOption = LayoutOptions.FillAndExpand, VerticalOption = LayoutOptions.FillAndExpand, Visibility = "true", Height = 50, BackGround = Color.FromHex("#D3D3D3"), CreateNewvisibility = "false", SelectedImageVisibility = "false", SelectedItemThickness = new Thickness(0, 0, 0, 0) },
#else
