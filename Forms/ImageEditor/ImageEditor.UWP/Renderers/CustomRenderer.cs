...
using WindowsMedia = Windows.UI.Xaml.Media;
...
namespace SampleBrowser.SfImageEditor.UWP.Renderers
{
    public class CustomEditorRenderer : EditorRenderer
    {
        ...
        protected override void OnElementChanged(ElementChangedEventArgs<Editor> e)
        {
            ...
            if (Control != null)
            {
                ...
                Control.Foreground = new WindowsMedia.SolidColorBrush(Colors.Black);
    ...
    public class CustomImageView : ICustomViewDependencyService
    {
        public object GetCustomView(string imageName, object context)
        {
            ...
            svgimage.Source = new WindowsMedia.Imaging.SvgImageSource(new Uri("ms-appx:///Assets/" + imageName + ".svg", UriKind.Absolute));
            return svgimage;
        }
