...
namespace SampleBrowser.SfBusyIndicator.Droid
{
    [Activity(Label = "SampleBrowser.SfBusyIndicator", Icon = "@drawable/AppIcon", Theme = "@style/MainTheme", MainLauncher = false, ConfigurationChanges = ConfigChanges.ScreenSize | ConfigChanges.Orientation)]
