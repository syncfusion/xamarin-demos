...
namespace SampleBrowser.SfStepProgressBar
{
    public partial class UserRegistration : SampleView
    {
        ...
        {
            (stepProgressBar.Children[0] as StepView).ImageSource = ImageSource.FromFile(accountSetUpPage[index]);
            (stepProgressBar.Children[1] as StepView).ImageSource = ImageSource.FromFile(personalPage[index]);
            (stepProgressBar.Children[2] as StepView).ImageSource = ImageSource.FromFile(profilePage[index]);
        }
