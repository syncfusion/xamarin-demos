...
namespace SampleBrowser.SfStepProgressBar
{
    public partial class UserRegistration : SampleView
    {
        ...
        public UserRegistration()
        {
            ...
            datePicker.Date.ToString(CultureInfo.InvariantCulture.DateTimeFormat);
        ...
        {
            DOBEntryField.Text = e.NewDate.Date.ToString("dd/MM/yyyy", CultureInfo.InvariantCulture.DateTimeFormat);
        }

        private void DatePicker_Unfocused(object sender, FocusEventArgs e)
        {
            DOBEntryField.Text = (e.VisualElement as DatePicker).Date.ToString("dd/MM/yyyy", CultureInfo.InvariantCulture.DateTimeFormat);
        }
