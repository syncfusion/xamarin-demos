...
using Android.OS;
using SampleBrowser.SfTimePicker.Droid;

namespace SampleBrowser.SfTimePicker.Droid
{
    [Activity(Label = "SampleBrowser.SfTimePicker", Icon = "@drawable/AppIcon", Theme = "@style/MainTheme", MainLauncher = false, ConfigurationChanges = ConfigChanges.ScreenSize | ConfigChanges.Orientation)]
