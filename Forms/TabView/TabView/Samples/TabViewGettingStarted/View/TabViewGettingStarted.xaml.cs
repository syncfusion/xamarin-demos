...
namespace SampleBrowser.SfTabView
{
    ...
    public partial class TabViewGettingStarted : SampleView
    {
        ...
        public TabViewGettingStarted()
        {
            ...
            EnableRippleAnimation.Toggled += EnableRippleAnimation_Toggled;
        }

        private void EnableRippleAnimation_Toggled(object sender, ToggledEventArgs e)
        {
            if (e.Value == true)
            {
              this.tabView.EnableRippleAnimation = true;
            }
            else
            {
              this.tabView.EnableRippleAnimation = false;
            }
        }
        ...
        void Handle_SelectedIndexChanged(object sender, System.EventArgs e)
        {
            ...
            switch (picker.SelectedIndex)
            {
                case 0:
                    ...
                    break;
                case 1:
                    tabView.IsScrollButtonEnabled = false;                    
