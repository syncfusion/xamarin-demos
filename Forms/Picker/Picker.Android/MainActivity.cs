...
using Android.OS;
using SampleBrowser.SfPicker.Droid;

namespace SampleBrowser.SfPicker.Droid
{
    [Activity(Label = "SampleBrowser.SfPicker", Icon = "@drawable/AppIcon", Theme = "@style/MainTheme", MainLauncher = false, ConfigurationChanges = ConfigChanges.ScreenSize | ConfigChanges.Orientation)]
