...
namespace SampleBrowser.SfPicker
{
	public partial class Cascading : SampleView
	{
		...
		private bool isPickerClosed = true;
		public Cascading()
		{
			...
			frompicker.Closing += Frompicker_Closing;
			...
			topicker.Closing += Topicker_Closing;
			...
			departpicker.Closing += Departpicker_Closing;
			departpicker.OkButtonClicked += Departpicker_OkButtonClicked;
			departpicker.CancelButtonClicked += Departpicker_CancelButtonClicked;
			arrivepicker.OnColumnLoaded += Arrivepicker_OnColumnLoaded;
			arrivepicker.Closing += Arrivepicker_Closing;
			arrivepicker.OkButtonClicked += Arrivepicker_OkButtonClicked;
			arrivepicker.CancelButtonClicked += Arrivepicker_CancelButtonClicked;
		...
		private void Departpicker_OkButtonClicked(object sender, Syncfusion.SfPicker.XForms.SelectionChangedEventArgs e)
		{
			isPickerClosed = false;
			departpicker.IsOpen = false;
		}

		private void Arrivepicker_CancelButtonClicked(object sender, Syncfusion.SfPicker.XForms.SelectionChangedEventArgs e)
		{
			isPickerClosed = false;
		...
		private void Arrivepicker_Closing(object sender, Syncfusion.XForms.Core.CancelEventArgs e)
		{
			e.Cancel = isPickerClosed;
		}

		private void Departpicker_Closing(object sender, Syncfusion.XForms.Core.CancelEventArgs e)
		{
			e.Cancel = isPickerClosed;
		}

		private void Topicker_Closing(object sender, Syncfusion.XForms.Core.CancelEventArgs e)
		{
			e.Cancel = isPickerClosed;
		}

		private void Frompicker_Closing(object sender, Syncfusion.XForms.Core.CancelEventArgs e)
		{
			e.Cancel = isPickerClosed;
		}
