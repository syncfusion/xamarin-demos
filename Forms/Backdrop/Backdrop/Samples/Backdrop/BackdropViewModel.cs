...
namespace SampleBrowser.SfBackdrop
{
    ...
    public class BackdropViewModel : INotifyPropertyChanged
    {
        ...
        {
            string assemblyName;
            Assembly assembly = typeof(Backdrop).GetTypeInfo().Assembly;
#if INDIVIDUALSB
            assemblyName = "SampleBrowser.SfBackdrop.";
#else
            ...
            {
                new BackdropModel(){ImageSource=ImageSource.FromResource(assemblyName + "Images.Brownie.png",assembly)},
                new BackdropModel(){ImageSource=ImageSource.FromResource(assemblyName + "Images.Cupcake.png",assembly)},
                new BackdropModel(){ImageSource=ImageSource.FromResource(assemblyName + "Images.Cake.png",assembly)},
                new BackdropModel(){ImageSource=ImageSource.FromResource(assemblyName + "Images.Icecake.png",assembly)},
                new BackdropModel(){ImageSource=ImageSource.FromResource(assemblyName + "Images.Cookie.png",assembly)},
                new BackdropModel(){ImageSource=ImageSource.FromResource(assemblyName + "Images.Biscuits.png",assembly)},
            };
...
#region private methods
        ...
        private void EdgeShapeChanged(object attachedObject)
        {
            ...
            SelectionChangedEventArgs selectionChangedEventArgs = list[0] as SelectionChangedEventArgs;
