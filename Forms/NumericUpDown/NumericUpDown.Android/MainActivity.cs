...
namespace SampleBrowser.SfNumericUpDown.Droid
{
    [Activity(Label = "SampleBrowser SfNumericUpDown",MainLauncher = false, Icon = "@drawable/AppIcon", Theme = "@style/MainTheme", ConfigurationChanges = ConfigChanges.ScreenSize | ConfigChanges.Orientation)]
