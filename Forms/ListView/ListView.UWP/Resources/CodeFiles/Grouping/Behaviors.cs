...
namespace SampleBrowser.SfListView
{
    ...
    public class SfListViewGroupingBehavior:Behavior<Syncfusion.ListView.XForms.SfListView>
    {
        ...
        private ListViewGroupingViewModel listViewGroupingViewModel;
        ...
        {
            ListView = bindable;
            listViewGroupingViewModel = new ListViewGroupingViewModel();
            ListView.ItemsSource = listViewGroupingViewModel.ContactsInfo;
