...
namespace SampleBrowser.SfDiagram
{
    public partial class Connectors : SampleView
    {
        ...
        void ChangeImage(string straight, string curve, string ortho)
        {
            StraightSegment.Image = straight;
            CurveSegment.Image = curve;
            OrthoSegment.Image = ortho;
        }
        private void OnStraight(object sender, EventArgs e)
        {
            ...
            ChangeImage("Straight1.png", "Curve.png", "Edge.png");
        }
        private void OnCurve(object sender, EventArgs e)
        {
            ...
            ChangeImage("Straight.png", "Curve1.png", "Edge.png");
        }
        private void OnOrtho(object sender, EventArgs e)
        {
            ...
            ChangeImage("Straight.png", "Curve.png", "Edge1.png");
        }
        ...
        void ColorChange(Color straight, Color curve, Color ortho)
        {
            StraightSegment.BackgroundColor = straight;
            CurveSegment.BackgroundColor = curve;
            OrthoSegment.BackgroundColor = ortho;
        }
    }
