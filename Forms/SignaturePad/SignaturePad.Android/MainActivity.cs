...
namespace SampleBrowser.SfSignaturePad.Droid
{
    [Activity(Label = "SampleBrowser.SfSignaturePad", Icon = "@drawable/AppIcon", Theme = "@style/MainTheme", MainLauncher = false, ConfigurationChanges = ConfigChanges.ScreenSize | ConfigChanges.Orientation)]
