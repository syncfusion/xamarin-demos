...
namespace SampleBrowser.SfDatePicker.Droid
{
    [Activity(Label = "SampleBrowser.SfDatePicker", Icon = "@drawable/AppIcon", Theme = "@style/MainTheme", MainLauncher = false, ConfigurationChanges = ConfigChanges.ScreenSize | ConfigChanges.Orientation)]
