...
namespace SampleBrowser.PDF
{
    public partial class Barcode : SampleView
    {
        ...
        void OnButtonClicked(object sender, EventArgs e)
        {
...
#if COMMONSB
            Stream imageStream = typeof(Barcode).GetTypeInfo().Assembly.GetManifestResourceStream("SampleBrowser.Samples.PDF.Samples.Assets.qrcodelogo.png");
#else
            //Set the logo image to QR barcode. 
            Stream imageStream = typeof(Barcode).GetTypeInfo().Assembly.GetManifestResourceStream("SampleBrowser.PDF.Samples.Assets.qrcodelogo.png");
#endif
            ...
            g.DrawString("Type : UPC-A", font, brush, new PointF(250, 460));
            g.DrawString("Allowed Characters : 0-9", font, brush, new PointF(250, 480));
            ...
            g.DrawString("Type : EAN-13", font, brush, new PointF(250, 550));
            g.DrawString("Allowed Characters : 0-9", font, brush, new PointF(250, 570));
            ...
            g.DrawString("Type : EAN-8", font, brush, new PointF(250, 640));
            g.DrawString("Allowed Characters : 0-9", font, brush, new PointF(250, 660));
