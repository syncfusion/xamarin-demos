The `SfCarousel` control provides rich visual navigation experience of image data. Also has efficient customization support and interactive navigation features.
