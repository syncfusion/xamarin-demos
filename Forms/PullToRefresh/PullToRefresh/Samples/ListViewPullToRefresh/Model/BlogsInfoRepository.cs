...
namespace SampleBrowser.SfPullToRefresh
{
    public class BlogsInfoRepository
    {
        ...
        {
            var blogsInfo = new ObservableCollection<ListViewBlogsInfo>();
...
#else
                    BlogAuthorIcon = ImageSource.FromResource("SampleBrowser.SfPullToRefresh.Icons.BlogAuthor.png", assembly),
                    BlogCategoryIcon = ImageSource.FromResource("SampleBrowser.SfPullToRefresh.Icons.BlogCategory.png", assembly),
                    BlogFacebookIcon = ImageSource.FromResource("SampleBrowser.SfPullToRefresh.Icons.Blog_Facebook.png", assembly),
                    BlogTwitterIcon = ImageSource.FromResource("SampleBrowser.SfPullToRefresh.Icons.Blog_Twitter.png", assembly),
                    BlogGooglePlusIcon = ImageSource.FromResource("SampleBrowser.SfPullToRefresh.Icons.Blog_Google Plus.png", assembly),
                    BlogLinkedInIcon = ImageSource.FromResource("SampleBrowser.SfPullToRefresh.Icons.Blog_LinkedIn.png", assembly),
#endif
        ...
        internal string[] BlogsTitle = new string[] { "Syncfusion is Attending dotnet Cologne and Magdeburger Dev Days Conferences",
            "Syncfusion Celebrates World Book Day", "What do e-books mean for developers?", 
            "Q&A from “File-Format Manipulation in Xamarin.Forms” Webinar", "Syncfusion Sponsoring Global Azure Bootcamp Chennai",
            ...
            "Syncfusion Celebrates Sim-Shipping Essential Studio with Visual Studio 2017", "Visual Studio: A Future and a Past",
        ...
        internal string[] BlogsCategory = new string[] { "Syncfusion", "Syncfusion", "E-book, Succinctly Series", 
        ...
        internal string[] BlogsAuthers = new string[] { "Jacqueline Bieringer", "loric@syncfusion.com", "Graham High", 
            "Darren West", "Marissa Keller Outten", "Darren West", "Graham High", "Tres Watkins", "Marissa Keller Outten", 
            "Jacqueline Bieringer", "Graham High", "Tres Watkins", "Syncfusion Guest Blogger", "Tres Watkins", "Darren West",
            "Jacqueline Bieringer", "Tres Watkins", "Marissa Keller Outten", "Jacqueline Bieringer", "Syncfusion Guest Blogger" };
