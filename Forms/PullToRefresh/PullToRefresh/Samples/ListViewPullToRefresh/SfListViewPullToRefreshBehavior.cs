...
#if COMMONSB
                    BlogAuthorIcon =
 ImageSource.FromResource("SampleBrowser.Icons.BlogAuthor.png", this.GetType().Assembly),
                    BlogCategoryIcon =
 ImageSource.FromResource("SampleBrowser.Icons.BlogCategory.png", this.GetType().Assembly),
                    BlogFacebookIcon =
 ImageSource.FromResource("SampleBrowser.Icons.Blog_Facebook.png", this.GetType().Assembly),
                    BlogTwitterIcon =
 ImageSource.FromResource("SampleBrowser.Icons.Blog_Twitter.png", this.GetType().Assembly),
                    BlogGooglePlusIcon =
 ImageSource.FromResource("SampleBrowser.Icons.Blog_Google Plus.png", this.GetType().Assembly),
                    BlogLinkedInIcon =
 ImageSource.FromResource("SampleBrowser.Icons.Blog_LinkedIn.png", this.GetType().Assembly),
#else
                    BlogAuthorIcon = ImageSource.FromResource(
                        "SampleBrowser.SfPullToRefresh.Icons.BlogAuthor.png",
