...
namespace SampleBrowser.SfDataGrid
{
    ...
    public class SelectionBehaviors : Behavior<SampleView>
    {
        ...
        [SuppressMessage("StyleCop.CSharp.DocumentationRules", "SA1600:ElementsMustBeDocumented", Justification = "Reviewed. Suppression is OK here.Private field does not need documentation")]
        private PickerExt selectionUnitPicker;
        [SuppressMessage("StyleCop.CSharp.DocumentationRules", "SA1600:ElementsMustBeDocumented", Justification = "Reviewed. Suppression is OK here.Private field does not need documentation")]
        ...
        /// <param name="sender">OnSelectionChanged event sender</param>
        /// <param name="e">EventArgs e</param>
        public void OnSelectionUnitChanged(object sender, EventArgs e)
        {
            if (this.selectionUnitPicker.SelectedIndex == 0)
            {
                this.dataGrid.SelectionUnit = SelectionUnit.Row;
                this.dataGrid.ShowRowHeader = false;
            }
            else if (this.selectionUnitPicker.SelectedIndex == 1)
            {
                this.dataGrid.SelectionUnit = SelectionUnit.Cell;
                this.dataGrid.ShowRowHeader = false;
            }
            else if (this.selectionUnitPicker.SelectedIndex == 2)
            {
                this.dataGrid.SelectionUnit = SelectionUnit.Any;
        ...
        protected override void OnAttachedTo(SampleView bindAble)
        {
            ...
            this.selectionUnitPicker = bindAble.FindByName<PickerExt>("SelectionUnitPicker");
            this.selectionUnitPicker.Items.Add("Row");
            this.selectionUnitPicker.Items.Add("Cell");
            this.selectionUnitPicker.Items.Add("Any");
            ...
            this.dataGrid.GridStyle = new SelectionControllerStyle();
            this.selectionUnitPicker.SelectedIndexChanged += this.OnSelectionUnitChanged;
