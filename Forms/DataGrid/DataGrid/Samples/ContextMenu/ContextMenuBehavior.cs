...
#else
            this.sortAscendingImage = this.CreateImage("SampleBrowser.SfDataGrid.Icons.DataGrid.Sort_Ascending_Icons.png");
            this.sortDescendingImage = this.CreateImage("SampleBrowser.SfDataGrid.Icons.DataGrid.Sort_descending_Icons.png");
            this.groupingImage = this.CreateImage("SampleBrowser.SfDataGrid.Icons.DataGrid.Grouping_Icon.png");
            this.clearSortingImage = this.CreateImage("SampleBrowser.SfDataGrid.Icons.DataGrid.Clear_sorting_Icon.png");
            this.clearGroupingImage = this.CreateImage("SampleBrowser.SfDataGrid.Icons.DataGrid.Clear_grouping_icon.png");
#endif
            if (this.dataGrid.GroupColumnDescriptions.Count > 0)
            {
