...
// ------------------------------------------------------------------------------------
// <copyright file = "CellTemplateBehavior.cs" company="Syncfusion.com">
...
#if COMMONSB
                Source = ImageSource.FromResource("SampleBrowser.Icons.DataGrid.EditIllustration.png",assembly),
#else
                    Source = ImageSource.FromResource("SampleBrowser.SfDataGrid.Icons.DataGrid.EditIllustration.png", assembly),
#endif
                },
            1,
            1);
