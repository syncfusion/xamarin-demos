    ...
    public class SwipingBehaviors : Behavior<SampleView>
    {
        ...
        private void LeftImage_BindingContextChanged(object sender, EventArgs e)
        {
            if (this.leftImage.Source == null)
            {
                ...
                if (Device.RuntimePlatform == Device.Android)
                {
                    this.leftImage.Source = ImageSource.FromResource("SampleBrowser.SfDataGrid.Icons.DataGrid.Edit.png", this.GetType().Assembly);
                }
                else if (Device.RuntimePlatform == Device.iOS)
                {
                    this.leftImage.Source = ImageSource.FromResource("SampleBrowser.SfDataGrid.Icons.DataGrid.SwipingIcon_iOS_Edit.png", this.GetType().Assembly);
                }
                else
                {
                    this.leftImage.Source = ImageSource.FromResource("SampleBrowser.SfDataGrid.Icons.DataGrid.SwipingIcon_UWP_Edit.png", this.GetType().Assembly);
                }
#endif
            }
        }
        ...
        private void RightImage_BindingContextChanged(object sender, EventArgs e)
        {
            if (this.rightImage.Source == null)
            {
                ...
                if (Device.RuntimePlatform == Device.Android)
                {
                    this.rightImage.Source = ImageSource.FromResource("SampleBrowser.SfDataGrid.Icons.DataGrid.Delete.png", this.GetType().Assembly);
                }
                else if (Device.RuntimePlatform == Device.iOS)
                {
                    this.rightImage.Source = ImageSource.FromResource("SampleBrowser.SfDataGrid.Icons.DataGrid.SwipingIcon_iOS_Delete.png", this.GetType().Assembly);
                }
                else
                {
                    this.rightImage.Source = ImageSource.FromResource("SampleBrowser.SfDataGrid.Icons.DataGrid.SwipingIcon_UWP_Delete.png", this.GetType().Assembly);
                }
#endif
            }
        }
