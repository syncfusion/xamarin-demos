    ...
    public class FormsView : StackLayout
    {
        ...
        public FormsView(Syncfusion.SfDataGrid.XForms.SfDataGrid grid)
        {
            ...
            if (Device.RuntimePlatform == Device.UWP || Device.RuntimePlatform == Device.macOS)
            {
                ...
                if (Device.RuntimePlatform == Device.UWP)
                {
                    this.SaveButton = new SfButton { WidthRequest = 150, FontSize = 16, HeightRequest = 80, Text = "SAVE", HorizontalOptions = LayoutOptions.CenterAndExpand, BackgroundColor = Color.FromHex("#333333"), TextColor = Color.White };
                    this.CancelButton = new SfButton { WidthRequest = 150, FontSize = 16, HeightRequest = 80, Text = "CANCEL", HorizontalOptions = LayoutOptions.CenterAndExpand, BackgroundColor = Color.FromHex("#333333"), TextColor = Color.White };                    
                }
                else
                {
            ...
            if (Device.RuntimePlatform == Device.UWP)
            {
                this.SaveButton.Clicked += this.Save_Clicked; 
                this.CancelButton.Clicked += this.Cancel_Clicked;
                this.Footer.Children.Add(new ContentView() { Content = this.SaveButton });
                this.Footer.Children.Add(new ContentView() { Content = this.CancelButton });
            }
            else
            {
        ...
        /// </summary>
        private SfButton SaveButton { get; set; }

        /// <summary>
        /// Gets or sets the value of Cancel
        /// </summary>
        private SfButton CancelButton { get; set; }
