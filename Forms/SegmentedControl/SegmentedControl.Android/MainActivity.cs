...
namespace SampleBrowser.SfSegmentedControl.Droid
{
    [Activity(Label = "SampleBrowser SfSegmentedControl", MainLauncher = false, Icon = "@drawable/AppIcon", Theme = "@style/MainTheme", ConfigurationChanges = ConfigChanges.ScreenSize | ConfigChanges.Orientation)]
