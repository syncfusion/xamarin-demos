...
using SegmentedEventArgs = Syncfusion.XForms.Buttons.SelectionChangedEventArgs;
...
namespace SampleBrowser.SegmentedControl
{
    ...
    public partial class SegmentViewGettingStarted : SampleView
    {
        ...
        /// <param name="e"></param>
        void Handle_SelectionChanged(object sender, SegmentedEventArgs e)
        {
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void ClothType_OnSelectionChanged(object sender, SegmentedEventArgs e)
        {
            var index = e.Index;
            if (index == 0)
            {
