...
#if COMMONSB
                    CustomerImage = ImageSource.FromResource("SampleBrowser.Icons.Image" + (i % 19) + ".png", assembly),
#else
                    CustomerImage = ImageSource.FromResource("SampleBrowser.DataSource.Icons.Image" + (i % 19) + ".png", assembly),
#endif
                };
                bookDetails.Add(ord);
            }
