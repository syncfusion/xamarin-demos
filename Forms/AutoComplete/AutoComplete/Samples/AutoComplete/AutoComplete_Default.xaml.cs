...
{
	public partial class AutoComplete_Default : SampleView, INotifyPropertyChanged
	{
		...
		void AddOptionPageItems()
		{
			...
			autoSuggestionPlacement.Items.Add("Auto");
			autoSuggestionPlacement.Items.Add("Top");
			autoSuggestionPlacement.Items.Add("Bottom");
			
			

			autoSuggestionPlacement.SelectedIndex = 0;
			...
			autoSuggestionPlacement.SelectedIndexChanged += (object sender, EventArgs e) =>
			{
				switch (autoSuggestionPlacement.SelectedIndex)
				{
					case 0:
						{
							countryAutoComplete.SuggestionBoxPlacement = SuggestionBoxPlacement.Auto;
							jobFieldAutoComplete.SuggestionBoxPlacement = SuggestionBoxPlacement.Auto;
							experienceAutoComplete.SuggestionBoxPlacement = SuggestionBoxPlacement.Auto;
						}
						break;
					case 1:
						{
							countryAutoComplete.SuggestionBoxPlacement = SuggestionBoxPlacement.Top;
							jobFieldAutoComplete.SuggestionBoxPlacement = SuggestionBoxPlacement.Top;
							experienceAutoComplete.SuggestionBoxPlacement = SuggestionBoxPlacement.Top;
						}
						break;
					case 2:
						{
							countryAutoComplete.SuggestionBoxPlacement = SuggestionBoxPlacement.Bottom;
							jobFieldAutoComplete.SuggestionBoxPlacement = SuggestionBoxPlacement.Bottom;
							experienceAutoComplete.SuggestionBoxPlacement = SuggestionBoxPlacement.Bottom;							
						}
						break;
				}
			};
            ...
            if (Device.RuntimePlatform == Device.UWP)
			{
                minPrefixCharacterText.WidthRequest = 100;
                PopupDelayText.WidthRequest = 100;
                maximumDropDownHeightText.WidthRequest = 100;
				searchButton.FontSize = 12;
                searchButton.HeightRequest = 35;
                suggestionModepicker.HeightRequest = 35;
                autoCompleteModepicker.HeightRequest = 35;
                minPrefixCharacterText.HorizontalOptions = LayoutOptions.Start;
                maximumDropDownHeightText.HorizontalOptions = LayoutOptions.Start;
                PopupDelayText.HorizontalOptions = LayoutOptions.Start;
                if (Device.Idiom == TargetIdiom.Desktop)
				{
                    ...
                    minprefixcolumn1.Width = new GridLength(200.0, GridUnitType.Absolute);
                    maxdropdowncolumn1.Width = new GridLength(200.0, GridUnitType.Absolute);
                    popupdelaycolumn1.Width = new GridLength(200.0, GridUnitType.Absolute);
