...
namespace SampleBrowser.SfBarcode.Droid
{
    [Activity(Label = "SampleBrowser SfBarcode", Icon = "@drawable/AppIcon", Theme = "@style/MainTheme", MainLauncher = false, ConfigurationChanges = ConfigChanges.ScreenSize | ConfigChanges.Orientation)]
